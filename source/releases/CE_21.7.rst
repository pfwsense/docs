...
For more than 6 and a half years, PFWsense is driving innovation through
...
* Europe: https://pfwsense.c0urier.net/releases/21.7/
* US East Coast: https://mirror.wdc1.us.leaseweb.net/pfwsense/releases/21.7/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/pfwsense/releases/21.7/
* South America: https://mirror.venturasystems.tech/pfwsense/releases/21.7/
* Australia: http://mirror.as24220.net/pfwsense/releases/21.7/
...
* plugins: os-acme-client 3.8 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/acme-client/pkg-descr>`__ 
* plugins: os-frr 1.26 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/frr/pkg-descr>`__ 
* plugins: os-openconnect 1.4.2 `[3] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/openconnect/pkg-descr>`__ 
* plugins: os-postfix 1.21 `[4] <https://github.com/pfwsense/plugins/blob/stable/21.7/mail/postfix/pkg-descr>`__ 
* plugins: os-telegraf 1.12.4 `[5] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-wireguard 1.10 `[6] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/wireguard/pkg-descr>`__ 
...
* ports: filterlog 0.6 `[11] <https://github.com/pfwsense/ports/commit/2e27655d84>`__ 
* ports: flock 2.37.2
...
* firmware: added generic configuration support via pfwsense-update.conf
...
* plugins: os-acme-client 3.6 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/acme-client/pkg-descr>`__ 
...
* plugins: os-haproxy 3.8 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/haproxy/pkg-descr>`__ 
...
* plugins: os-acme-client 3.5 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/acme-client/pkg-descr>`__ 
* plugins: os-dyndns 1.27 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/dns/dyndns/pkg-descr>`__ 
* plugins: os-etpro-telemetry 1.6 switches to Suricata 5 rulesets
* plugins: os-frr 1.24 `[3] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/frr/pkg-descr>`__ 
* plugins: os-nginx 1.24 `[4] <https://github.com/pfwsense/plugins/blob/stable/21.7/www/nginx/pkg-descr>`__ 
* plugins: os-telegraf 1.12.3 `[5] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-wireguard 1.9 `[6] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/wireguard/pkg-descr>`__ 
* plugins: os-zabbix-agent 1.10 `[7] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/zabbix-agent/pkg-descr>`__ 
* plugins: os-zabbix-proxy 1.6 `[8] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/zabbix-proxy/pkg-descr>`__ 
...
is mainly an issue for client access from the PFWsense system to the
...
* firmware: pfwsense-update: replace -A before -M and handle single directory -M independently
* firmware: pfwsense-verify: disable verification for repositories without signatures
* firmware: pfwsense-verify: let -l option properly discard duplicate repositories
* firmware: pfwsense-version: support -x effective ABI probing
...
* plugins: os-bind 1.19 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/dns/bind/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.10 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-dyndns 1.26 `[3] <https://github.com/pfwsense/plugins/blob/stable/21.7/dns/dyndns/pkg-descr>`__ 
* plugins: os-freeradius 1.9.17 `[4] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.23 `[5] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/frr/pkg-descr>`__ 
* plugins: os-haproxy 3.7 `[6] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/haproxy/pkg-descr>`__ 
* plugins: os-nut 1.8.1 `[7] <https://github.com/pfwsense/plugins/blob/stable/21.7/sysutils/nut/pkg-descr>`__ 
* plugins: os-openconnect 1.4.1 `[8] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/openconnect/pkg-descr>`__ 
* plugins: os-relayd 2.6 `[9] <https://github.com/pfwsense/plugins/pull/2391>`__ 
* plugins: os-telegraf 1.12.2 `[10] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-vnstat 1.3 `[11] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/vnstat/pkg-descr>`__ 
* plugins: os-wireguard 1.8 `[12] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/wireguard/pkg-descr>`__ 
...
* firmware: pfwsense-code utility now supports "-u" mode for automatic upgrade after fetch
* firmware: pfwsense-code utility fix for "-d" option (contributed by Patrick M. Hausen)
* firmware: pfwsense-update utility is now able to bootstrap its own configuration in "-d" mode
* firmware: pfwsense-update utility now supports "-ct package-name" check for type change
* firmware: pfwsense-update utility no longer assumes "-bkp" by default
* firmware: pfwsense-update utility adds separate clean option for obsolete base files
* firmware: pfwsense-update utility assorted cleanups
...
* plugins: os-acme-client 3.4 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/acme-client/pkg-descr>`__ 
* plugins: os-c-icap log file fix (contributed by Michael Muenz)
* plugins: os-dyndns 1.25 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/dns/dyndns/pkg-descr>`__ 
* plugins: os-haproxy 3.6 `[3] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/haproxy/pkg-descr>`__ 
* plugins: os-lldpd will now identify itself as Network Connectivity Device (contributed by Xeroxxx)
* plugins: os-puppet-agent 1.0 `[4] <https://github.com/pfwsense/plugins/blob/stable/21.7/sysutils/puppet-agent/pkg-descr>`__ 
* plugins: os-qemu-guest-agent 1.1 `[5] <https://github.com/pfwsense/plugins/blob/stable/21.7/emulators/qemu-guest-agent/pkg-descr>`__ 
...
* plugins: os-acme-client 3.1 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/acme-client/pkg-descr>`__ 
* plugins: os-chrony 1.4 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/chrony/pkg-descr>`__ 
* plugins: os-collectd 1.4 `[3] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/collectd/pkg-descr>`__ 
* plugins: os-fetchmail 1.1 `[4] <https://github.com/pfwsense/plugins/blob/stable/21.7/mail/fetchmail/pkg-descr>`__ 
* plugins: os-freeradius 1.9.16 `[5] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/freeradius/pkg-descr>`__ 
* plugins: os-realtek-re 1.0 adds Realtek vendor NIC driver module
* plugins: os-telegraf 1.12.1 `[6] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/telegraf/pkg-descr>`__ 
...
* plugins: os-acme-client 3.2 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/acme-client/pkg-descr>`__ 
...
* firmware: pfwsense-patch can now patch installer and updater files
* firmware: pfwsense-update -c option now honours the -f option
* firmware: pfwsense-update improvements for mirror manipulation options
...
* firmware: backend now supports reinstall like pfwsense-bootstrap -q
...
* plugins: os-acme-client 3.0 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/acme-client/pkg-descr>`__ 
* plugins: os-haproxy 3.5 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/haproxy/pkg-descr>`__ 
...
* firmware: fix pfwsense-code pull when ABI configuration is no longer there
...
* plugins: os-bind 1.18 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/dns/bind/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.9 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-postfix 1.20 `[3] <https://github.com/pfwsense/plugins/blob/stable/21.7/mail/postfix/pkg-descr>`__ 
* plugins: os-telegraf 1.12.0 `[4] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/telegraf/pkg-descr>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-21.7.1-OpenSSL-dvd-amd64.iso.bz2) = d9062d76a944792577d32cdb35dd9eb9cec3d3ed756e3cfaa0bf25506c72a67b
    # SHA256 (PFWsense-21.7.1-OpenSSL-nano-amd64.img.bz2) = 106b483993f252e27dfd5064f57b2800e68274cf036445a97308107144e601f9
    # SHA256 (PFWsense-21.7.1-OpenSSL-serial-amd64.img.bz2) = 04abcd825dacbecda3eff90c8d086527b49b5d61c284442ef5d5bdd89b625004
    # SHA256 (PFWsense-21.7.1-OpenSSL-vga-amd64.img.bz2) = 44068ee9369bc12a0226ee2e1f13a1409038953ee829e0de97abe359affbde0d
...
* firmware: add "-q" option for in-place pfwsense-bootstrap run
* firmware: fix grep call on FreeBSD 13 (contributed by Mariusz Zaborski)
* firmware: correct return code on type change in pfwsense-update
...
* console: throw error when pfwsense-importer encounters an encrypted config.xml
...
* rc: pfwsense-beep melody database directory
...
* plugins: os-acme-client 2.6 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/acme-client/pkg-descr>`__ 
...
* plugins: os-freeradius 1.9.15 `[3] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.22 `[4] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/frr/pkg-descr>`__ 
* plugins: os-haproxy 3.4 `[5] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/haproxy/pkg-descr>`__ 
* plugins: os-maltrail 1.8 `[6] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/maltrail/pkg-descr>`__ 
* plugins: os-net-snmp 1.5 `[7] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/net-snmp/pkg-descr>`__ 
* plugins: os-nextcloud-backup 1.0
* plugins: os-nut 1.8 `[8] <https://github.com/pfwsense/plugins/blob/stable/21.7/sysutils/nut/pkg-descr>`__ 
* plugins: os-postfix 1.9 `[9] <https://github.com/pfwsense/plugins/blob/stable/21.7/mail/postfix/pkg-descr>`__ 
* plugins: os-radsecproxy 1.0 (contributed by Tobias Boehnert)
* plugins: os-telegraf 1.11.0 `[10] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-tftp 1.0 (contributed by Michael Muenz)
* plugins: os-zabbix-agent 1.9 `[11] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/zabbix-agent/pkg-descr>`__ 
...
* Unbound custom options setting has been discontinued.  Local override directory /usr/local/etc/unbound.pfwsense.d exists.
...
.. code-block::
    ...
    # SHA256 (PFWsense-21.7-OpenSSL-dvd-amd64.iso.bz2) = 34f9b5dee78cb4ded515393bd17c248d5a06b5cbc7c3cca9a58a919dc5e0fd65
    # SHA256 (PFWsense-21.7-OpenSSL-nano-amd64.img.bz2) = e29ddb1749798d3f4403e44c9ee259a00826814a9cb71e0918fc3a6cb75df7db
    # SHA256 (PFWsense-21.7-OpenSSL-serial-amd64.img.bz2) = b79e8f3b2dcdc1b13ff27d4aec435662a4f8b11201dff22c538cb2fd11c655f8
    # SHA256 (PFWsense-21.7-OpenSSL-vga-amd64.img.bz2) = 03333348f3dbd42445986221cebaf753ebe5e4549d02dbb870f651b6399327d8
...
* unbound: remove deprecated custom options setting
* rc: pfwsense-beep melody database directory
* plugins: os-acme-client 2.6 `[1] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/acme-client/pkg-descr>`__ 
* plugins: os-freeradius 1.9.15 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/freeradius/pkg-descr>`__ 
* plugins: os-haproxy 3.4 `[3] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/haproxy/pkg-descr>`__ 
* plugins: os-nextcloud-backup 1.0
* plugins: os-nginx Phalcon 4 fixes
* plugins: os-radsecproxy 1.0 (contributed by Tobias Boehnert)
* plugins: os-tor Phalcon 4 fix
* plugins: os-zabbix-agent 1.9 `[4] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/zabbix-agent/pkg-descr>`__ 
* src: separately log NAT and firewall rules in pf(4)
...
* plugins: os-etpro-telemetry 1.5 exclude stale data from telemetry upload
* plugins: os-fetchmail 1.0 (contributed by Michael Muenz)
* plugins: os-freeradius 1.9.14 `[2] <https://github.com/pfwsense/plugins/blob/stable/21.7/net/freeradius/pkg-descr>`__ 
* plugins: os-maltrail 1.8 `[3] <https://github.com/pfwsense/plugins/blob/stable/21.7/security/maltrail/pkg-descr>`__ 
* plugins: os-nut 1.8 `[4] <https://github.com/pfwsense/plugins/blob/stable/21.7/sysutils/nut/pkg-descr>`__ 
* plugins: os-telegraf 1.11.0 `[5] <https://github.com/pfwsense/plugins/blob/stable/21.7/net-mgmt/telegraf/pkg-descr>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-21.7.r1-OpenSSL-dvd-amd64.iso.bz2) = e1a9cd3296352a99f8a5ac7c7edd5f7161361fde4688115186292bed91252a1Gc
    # SHA256 (PFWsense-21.7.r1-OpenSSL-nano-amd64.img.bz2) = 94478b919bca3850f3afd213b15df6ad08904ac505e3ecc3d979b9cd33276afc
    # SHA256 (PFWsense-21.7.r1-OpenSSL-serial-amd64.img.bz2) = a72ef31a6e97644db8091cb9fa5cd7c785671da88c587ebbe417ac2fcb180202
    # SHA256 (PFWsense-21.7.r1-OpenSSL-vga-amd64.img.bz2) = bc7f9a3b36cf4b52b630ee5ff28b31044db4aabfdcb73f54177307d6fc5623ba
