...
The PFWsense business edition transitions to this 23.10 release including
...
This business release is based on the PFWsense 23.7.12 community version
...
* plugins: os-acme-client 3.20 `[2] <https://github.com/pfwsense/plugins/blob/stable/23.7/security/acme-client/pkg-descr>`__ 
* plugins: os-bind 1.29 `[3] <https://github.com/pfwsense/plugins/blob/stable/23.7/dns/bind/pkg-descr>`__ 
* plugins: os-ddclient 1.20 `[4] <https://github.com/pfwsense/plugins/blob/stable/23.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-dec-hw 1.0 is a Deciso hardware specific dashboard widget
* plugins: os-frr 1.38 `[5] <https://github.com/pfwsense/plugins/blob/stable/23.7/net/frr/pkg-descr>`__ 
* plugins: os-node_exporter 1.2 `[6] <https://github.com/pfwsense/plugins/blob/stable/23.7/sysutils/node_exporter/pkg-descr>`__ 
* plugins: os-sunnyvalley 1.4 switches to new repository layout
* plugins: os-telegraf 1.12.10 `[7] <https://github.com/pfwsense/plugins/blob/stable/23.7/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-upnp now reloads on newwanip event
* plugins: os-wireguard 2.6 `[8] <https://github.com/pfwsense/plugins/blob/stable/23.7/net/wireguard/pkg-descr>`__ 
...
This business release is based on the PFWsense 23.7.9 community version
with additional reliability improvements.
...
* plugins: os-ddclient 1.17 `[2] <https://github.com/pfwsense/plugins/blob/stable/23.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-frr 1.37 `[3] <https://github.com/pfwsense/plugins/blob/stable/23.7/net/frr/pkg-descr>`__ 
* plugins: os-net-snmp fix for directory setup (contributed by doktornotor)
* plugins: os-nginx 1.32.2 `[4] <https://github.com/pfwsense/plugins/blob/stable/23.7/www/nginx/pkg-descr>`__ 
* plugins: os-openconnect 1.4.5 `[5] <https://github.com/pfwsense/plugins/blob/stable/23.7/security/openconnect/pkg-descr>`__ 
* plugins: os-rspamd 1.13 `[6] <https://github.com/pfwsense/plugins/blob/stable/23.7/mail/rspamd/pkg-descr>`__ 
...
* plugins: os-wireguard 2.5 `[7] <https://github.com/pfwsense/plugins/blob/stable/23.7/net/wireguard/pkg-descr>`__ 
...
This business release is based on the PFWsense 23.7.6 community version
with additional reliability improvements.
...
* plugins: os-acme-client 3.19 `[3] <https://github.com/pfwsense/plugins/blob/stable/23.7/security/acme-client/pkg-descr>`__ 
* plugins: os-bind 1.27 `[4] <https://github.com/pfwsense/plugins/blob/stable/23.7/dns/bind/pkg-descr>`__ 
* plugins: os-crowdsec 1.0.7 `[5] <https://github.com/pfwsense/plugins/blob/stable/23.7/security/crowdsec/pkg-descr>`__ 
* plugins: os-ddclient 1.16 `[6] <https://github.com/pfwsense/plugins/blob/stable/23.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.14 `[7] <https://github.com/pfwsense/plugins/blob/stable/23.7/dns/dnscrypt-proxy/pkg-descr>`__ 
...
* plugins: os-frr 1.36 `[8] <https://github.com/pfwsense/plugins/blob/stable/23.7/net/frr/pkg-descr>`__ 
...
* plugins: os-telegraf 1.12.9 `[9] <https://github.com/pfwsense/plugins/blob/stable/23.7/net-mgmt/telegraf/pkg-descr>`__ 
...
* plugins: os-wazuh-agent 1.0 `[10] <https://docs.pfwsense.org/manual/wazuh-agent.html>`__ 
* plugins: os-wireguard 2.3 `[11] <https://github.com/pfwsense/plugins/blob/stable/23.7/net/wireguard/pkg-descr>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-business-23.10-dvd-amd64.iso.bz2) = a021526f48239f13b954b51b2e4537f43923ed29e7ad85be72266a0887d8be32
    # SHA256 (PFWsense-business-23.10-nano-amd64.img.bz2) = 0daa99954c17259f4edb25a58ab8d867670363385211e4d641403f7f3f4b6554
    # SHA256 (PFWsense-business-23.10-serial-amd64.img.bz2) = 4f4b320cd2aa2833661ba64d6c8ec31e5f60f0040426cb2a6df729c00a247f8a
    # SHA256 (PFWsense-business-23.10-vga-amd64.img.bz2) = f3e672e1e3c7b0fba1bc265688a81cd65ced5053e7751cebce27282dd480c227
