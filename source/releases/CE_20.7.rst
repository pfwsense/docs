...
For five and a half years, PFWsense is driving innovation through modularising
...
* Europe: https://mirrors.dotsrc.org/pfwsense/releases/20.7/
* US East Coast: http://mirrors.nycbug.org/pub/pfwsense/releases/20.7/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/pfwsense/releases/20.7/
* South America: https://mirror.venturasystems.tech/pfwsense/releases/20.7/
* Australia: http://mirror.as24220.net/pfwsense/releases/20.7/
...
* firmware: pfwsense-code now updates the current directory if nothing was specified
* firmware: pfwsense-code now uses flexible make.conf target from tools.git
* firmware: pfwsense-update now supports snapshot access via -z option
* firmware: pfwsense-update now fixes missing dependencies on the fly
...
* plugins: os-haproxy 2.26 `[1] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/haproxy/pkg-descr>`__ 
...
* plugins: os-nginx 1.20 `[2] <https://github.com/pfwsense/plugins/blob/stable/20.7/www/nginx/pkg-descr>`__ 
...
* plugins: os-acme-client 2.2 `[1] <https://github.com/pfwsense/plugins/blob/stable/20.7/security/acme-client/pkg-descr>`__ 
* plugins: os-freeradius 1.9.9 `[2] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.20 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/frr/pkg-descr>`__ 
* plugins: os-tinc 1.6 enables multiple addresses per host (contributed by ElNounch)
* plugins: os-wireguard 1.4 `[4] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/wireguard/pkg-descr>`__ 
...
* plugins: os-acme-client 2.1 `[1] <https://github.com/pfwsense/plugins/blob/stable/20.7/security/acme-client/pkg-descr>`__ 
* plugins: os-frr 1.19 `[2] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/frr/pkg-descr>`__ 
...
* plugins: os-acme-client 2.0 `[1] <https://github.com/pfwsense/plugins/blob/stable/20.7/security/acme-client/pkg-descr>`__ 
* plugins: os-bind 1.14 `[2] <https://github.com/pfwsense/plugins/blob/stable/20.7/dns/bind/pkg-descr>`__ 
* plugins: os-chrony 1.1 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/chrony/pkg-descr>`__ 
...
* plugins: os-freeradius 1.9.8 `[1] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/freeradius/pkg-descr>`__ 
* plugins: os-git-backup 1.0 `[2] <https://github.com/pfwsense/plugins/issues/2049>`__  (sponsored by Modirum)
...
* plugins: os-frr 1.17 `[1] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/frr/pkg-descr>`__ 
* plugins: os-postfix 1.17 `[2] <https://github.com/pfwsense/plugins/blob/stable/20.7/mail/postfix/pkg-descr>`__ 
* plugins: os-rspamd 1.10 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.7/mail/rspamd/pkg-descr>`__ 
...
* plugins: os-wireguard 1.3 `[4] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/wireguard/pkg-descr>`__ 
* plugins: os-zabbix-agent 1.8 `[5] <https://github.com/pfwsense/plugins/blob/stable/20.7/net-mgmt/zabbix-agent/pkg-descr>`__ 
...
* plugins: os-acme-client 1.36 `[1] <https://github.com/pfwsense/plugins/pull/1974>`__ 
* plugins: os-dyndns 1.23 adds Gandi LiveDNS support (contributed by vizion8-dan)
* plugins: os-haproxy 2.24 `[2] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/haproxy/pkg-descr>`__ 
* plugins: os-stunnel 1.0.1 includes performance tweaks
* plugins: os-telegraf 1.8.2 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.7/net-mgmt/telegraf/pkg-descr>`__ 
...
* plugins: os-acme-client 1.35 `[1] <https://github.com/pfwsense/plugins/pull/1950>`__ 
* plugins: os-frr 1.15 `[2] <https://github.com/pfwsense/plugins/blob/stable/20.7/net/frr/pkg-descr>`__ 
* plugins: os-postfix 1.15 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.7/mail/postfix/pkg-descr>`__ 
...
* plugins: os-collectd 1.3 `[2] <https://github.com/pfwsense/plugins/blob/stable/20.7/net-mgmt/collectd/pkg-descr>`__ 
* plugins: os-zabbix5-proxy 1.3 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.7/net-mgmt/zabbix5-proxy/pkg-descr>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-20.7-OpenSSL-dvd-amd64.iso.bz2) = 580070a3a0533418d58eaeb78122f804f2df7081c929288e1dccee34c4bf763a
    # SHA256 (PFWsense-20.7-OpenSSL-nano-amd64.img.bz2) = 6deb370c2a64fa6c60b7f59a4afb31b2dd28b812f5fcd59eaa6d458938d45630
    # SHA256 (PFWsense-20.7-OpenSSL-serial-amd64.img.bz2) = 1276cddd5f7b89aa54fc4a1517cb0686efe94f672627243c5b34d93340441d60
    # SHA256 (PFWsense-20.7-OpenSSL-vga-amd64.img.bz2) = 72cbffe3bba4884586c8ded8dbca4cf30fb34a094602e5f681efde2deea595c6
...
* plugins: os-telegraf 1.8.1 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.7/net-mgmt/telegraf/pkg-descr>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-20.7.r1-OpenSSL-dvd-amd64.iso.bz2) = d54dca6390497d45b831f68f352fccf84881aac78a360247965e5c9b36fbfded
    # SHA256 (PFWsense-20.7.r1-OpenSSL-nano-amd64.img.bz2) = f78d51d53bf663df2d49a3724812893d8c55234ab8d4a9232663fa581496edbe
    # SHA256 (PFWsense-20.7.r1-OpenSSL-serial-amd64.img.bz2) = 984f8c9d63598f061cc8995245dea73703532c1bb688ac87cdb1e510fb53b80e
    # SHA256 (PFWsense-20.7.r1-OpenSSL-vga-amd64.img.bz2) = 711811e0a7d37d323a060c52590daa9f024e77c6da627530c6596367a09b412d
