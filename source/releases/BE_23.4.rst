...
The PFWsense business edition transitions to this 23.4 release including
...
This business release is based on the PFWsense 23.1.11 community version
...
* ports: strongswan upstream fix for VICI stalls `[18] <https://github.com/pfwsense/core/issues/6308>`__ 
...
This business release is based on the PFWsense 23.1.9 community version
with additional reliability improvements.
...
* plugins: os-bind 1.26 `[3] <https://github.com/pfwsense/plugins/blob/stable/23.1/dns/bind/pkg-descr>`__ 
* plugins: os-crowdsec 1.0.5 `[4] <https://github.com/pfwsense/plugins/blob/stable/23.1/security/crowdsec/pkg-descr>`__ 
* plugins: os-ddclient 1.13 `[5] <https://github.com/pfwsense/plugins/blob/stable/23.1/dns/ddclient/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.13 `[6] <https://github.com/pfwsense/plugins/blob/stable/23.1/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-nginx 1.32 `[7] <https://github.com/pfwsense/plugins/blob/stable/23.1/www/nginx/pkg-descr>`__ 
...
* src: bridge: add support for emulated netmap mode `[8] <https://github.com/pfwsense/src/commit/eebd4b140f>`__ 
...
* src: netmap: fix queue stalls with generic interfaces `[9] <https://github.com/pfwsense/src/commit/cc92d78fa5>`__ 
...
This business release is based on the PFWsense 23.1.5 community version
with additional reliability improvements.
...
* plugins: os-acme-client 3.16 `[3] <https://github.com/pfwsense/plugins/blob/stable/23.1/security/acme-client/pkg-descr>`__ 
* plugins: os-api-backup 1.1 `[4] <https://github.com/pfwsense/plugins/blob/stable/23.1/sysutils/api-backup/pkg-descr>`__ 
* plugins: os-bind 1.25 `[5] <https://github.com/pfwsense/plugins/blob/stable/23.1/dns/bind/pkg-descr>`__ 
* plugins: os-crowdsec 1.0.2 `[6] <https://github.com/pfwsense/plugins/blob/stable/23.1/security/crowdsec/pkg-descr>`__ 
* plugins: os-ddclient 1.11 `[7] <https://github.com/pfwsense/plugins/blob/stable/23.1/dns/ddclient/pkg-descr>`__ 
* plugins: os-freeradius 1.9.22 `[8] <https://github.com/pfwsense/plugins/blob/stable/23.1/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.33 `[9] <https://github.com/pfwsense/plugins/blob/stable/23.1/net/frr/pkg-descr>`__ 
* plugins: os-haproxy 4.1 `[10] <https://github.com/pfwsense/plugins/blob/stable/23.1/net/haproxy/pkg-descr>`__ 
* plugins: os-openconnect 1.4.4 `[11] <https://github.com/pfwsense/plugins/blob/stable/23.1/security/openconnect/pkg-descr>`__ 
* plugins: os-puppet-agent 1.1 `[12] <https://github.com/pfwsense/plugins/blob/stable/23.1/sysutils/puppet-agent/pkg-descr>`__ 
* plugins: os-qemu-guest-agent 1.2 `[13] <https://github.com/pfwsense/plugins/blob/stable/23.1/emulators/qemu-guest-agent/pkg-descr>`__ 
* plugins: os-rfc2136 1.8 `[14] <https://github.com/pfwsense/plugins/blob/stable/23.1/dns/rfc2136/pkg-descr>`__ 
* plugins: os-sslh 1.0 `[15] <https://github.com/pfwsense/plugins/blob/stable/23.1/net/sslh/pkg-descr>`__  (contributed by agh1467)
...
* plugins: os-upnp 1.5 `[16] <https://github.com/pfwsense/plugins/blob/stable/23.1/net/upnp/pkg-descr>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-business-23.4-dvd-amd64.iso.bz2) = 7136d0d78e643b59bbee8866f7aa1498325bd5513af30a9ace6005aeb1638707
    # SHA256 (PFWsense-business-23.4-nano-amd64.img.bz2) = 84b4a5ede947aae38273c4b57ddea2122764508e5309d3e1bbb816128097ce35
    # SHA256 (PFWsense-business-23.4-serial-amd64.img.bz2) = 9da2a93f6ad246c2f02655a1d5468755b1af6b500ff2e1846c0506c956c8f84b
    # SHA256 (PFWsense-business-23.4-vga-amd64.img.bz2) = 982a47835be03787f0a8d408aff0e117a3a5bccd810aa510808c4804abab66c4
