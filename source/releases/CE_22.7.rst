...
* Europe: https://pfwsense.c0urier.net/releases/22.7/
* US East Coast: https://mirror.wdc1.us.leaseweb.net/pfwsense/releases/22.7/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/pfwsense/releases/22.7/
* South America: http://mirror.ueb.edu.ec/pfwsense/releases/22.7/
* East Asia: https://mirror.ntct.edu.tw/pfwsense/releases/22.7/
...
* system: fix a few minor Coverity Scan reports in Python code `[1] <https://scan.coverity.com/projects/pfwsense-core>`__ 
...
* plugins: os-acme-client 3.15 `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/acme-client/pkg-descr>`__ 
...
* plugins: os-clamav 1.8 `[1] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/clamav/pkg-descr>`__ 
* plugins: os-ddclient IPv6 parsing fix `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/dns/ddclient/pkg-descr>`__ 
...
* system: fix a few minor Coverity Scan reports in PHP code `[1] <https://scan.coverity.com/projects/pfwsense-core>`__ 
...
* plugins: os-telegraf 1.12.7 `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/net-mgmt/telegraf/pkg-descr>`__ 
...
* plugins: os-nginx 1.31 `[1] <https://github.com/pfwsense/plugins/blob/stable/22.7/www/nginx/pkg-descr>`__ 
...
* intrusion detection: missing PFWsense categories
...
* plugins: os-acme-client 3.14 `[1] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/acme-client/pkg-descr>`__ 
* plugins: os-apcupsd 1.1 `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/sysutils/apcupsd/pkg-descr>`__ 
* plugins: os-frr 1.31 `[3] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/frr/pkg-descr>`__ 
* plugins: os-haproxy 3.12 `[4] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/haproxy/pkg-descr>`__ 
* plugins: os-maltrail 1.10 `[5] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/maltrail/pkg-descr>`__ 
* plugins: os-openconnect 1.4.3 `[6] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/openconnect/pkg-descr>`__ 
* plugins: os-telegraf 1.12.6 `[7] <https://github.com/pfwsense/plugins/blob/stable/22.7/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-tor 1.9 enables hardware acceleration (contributed by haarp)
* plugins: os-wireguard 1.13 `[8] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/wireguard/pkg-descr>`__ 
...
* interfaces: allow user-configurable VLAN device names with certain restrictions `[1] <https://github.com/pfwsense/core/issues/6038>`__ 
...
* firmware: pfwsense-update: return subscription key via -K if it exists
...
* plugins: os-crowdsec 1.0.1 `[1] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/crowdsec/pkg-descr>`__ 
* plugins: os-ddclient 1.9 `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-freeradius 1.9.21 `[3] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/freeradius/pkg-descr>`__ 
* plugins: os-nginx 1.30 `[4] <https://github.com/pfwsense/plugins/blob/stable/22.7/www/nginx/pkg-descr>`__ 
...
* plugins: os-frr 1.30 `[1] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/frr/pkg-descr>`__ 
* plugins: os-nginx now uses simplified NAME_setup service handling
* plugins: os-wireguard 1.12 `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/wireguard/pkg-descr>`__ 
* plugins: os-zabbix-agent 1.13 `[3] <https://github.com/pfwsense/plugins/blob/stable/22.7/net-mgmt/zabbix-agent/pkg-descr>`__ 
* plugins: os-zabbix-proxy 1.9 `[4] <https://github.com/pfwsense/plugins/blob/stable/22.7/net-mgmt/zabbix-proxy/pkg-descr>`__ 
...
* firewall: add BGP ASN type to aliases `[1] <https://docs.pfwsense.org/manual/aliases.html#bgp-asn>`__ 
...
* firmware: pfwsense-patch: only remove ".sh" suffix for installer and update repos
* firmware: pfwsense-update: only set packages marker after successful upgrade
* firmware: pfwsense-bootstrap: set correct packages marker
* firmware: revoke 22.1 fingerprint
* plugins: os-radsecproxy is no longer available on LibreSSL due to upstream build issues
* plugins: os-acme-client 3.13 `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/acme-client/pkg-descr>`__ 
* plugins: os-bind 1.24 `[3] <https://github.com/pfwsense/plugins/blob/stable/22.7/dns/bind/pkg-descr>`__ 
* plugins: os-haproxy 3.11 `[4] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/haproxy/pkg-descr>`__ 
* plugins: os-git-backup hides SSH keys by default
* plugins: os-postfix disables GSSAPI for the time being `[5] <https://github.com/pfwsense/plugins/blob/stable/22.7/mail/postfix/pkg-descr>`__ 
...
* plugins: os-acme-client 3.12 `[1] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/acme-client/pkg-descr>`__ 
* plugins: os-freeradius 1.9.20 `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/freeradius/pkg-descr>`__ 
...
* plugins: os-maltrail 1.9 `[3] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/maltrail/pkg-descr>`__ 
* plugins: os-munin-node 1.1 `[4] <https://github.com/pfwsense/plugins/blob/stable/22.7/sysutils/munin-node/pkg-descr>`__ 
* plugins: os-netdata 1.2 `[5] <https://github.com/pfwsense/plugins/blob/stable/22.7/net-mgmt/netdata/pkg-descr>`__ 
* plugins: os-nginx 1.29 `[6] <https://github.com/pfwsense/plugins/blob/stable/22.7/www/nginx/pkg-descr>`__ 
...
* plugins: os-apcupsd 1.0 `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/sysutils/apcupsd/pkg-descr>`__  (contributed by David Berry, Dan Lundqvist and Nicola Pellegrini)
* plugins: os-boot-delay is no longer available `[3] <https://github.com/pfwsense/plugins/blob/b31bcb92106/sysutils/boot-delay/Makefile#L6>`__ 
* plugins: os-crowdsec 1.0 `[4] <https://github.com/pfwsense/plugins/blob/stable/22.7/security/crowdsec/pkg-descr>`__ 
* plugins: os-nginx fix for missing DH parameter file
* plugins: os-postfix fix for missing DH parameter file
* plugins: os-tayga 1.2 `[5] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/tayga/pkg-descr>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-22.7-OpenSSL-dvd-amd64.iso.bz2) = 9345057e993cd55dfa5280beefd33f1dc2243681defff3c5f11b84fa2c7910f8
    # SHA256 (PFWsense-22.7-OpenSSL-nano-amd64.img.bz2) = 061ea4ca261bcd8397ae1a4acf2fb32f0fbbb6ac00d617e1f4151318f66cc77d
    # SHA256 (PFWsense-22.7-OpenSSL-serial-amd64.img.bz2) = cf1603e20d4268d917b40344ddadd2f147c3e167dbe1f6cd254a2afcb586fb4d
    # SHA256 (PFWsense-22.7-OpenSSL-vga-amd64.img.bz2) = 2537f37247d98e27634c34cdf23f30f95d0ed00ac0af01c2d9675580a790f8fb
...
* plugins: os-apcupsd 1.0 `[2] <https://github.com/pfwsense/plugins/blob/stable/22.7/sysutils/apcupsd/pkg-descr>`__  (contributed by David Berry, Dan Lundqvist and Nicola Pellegrini)
* plugins: os-boot-delay is no longer available `[3] <https://github.com/pfwsense/plugins/blob/b31bcb92106/sysutils/boot-delay/Makefile#L6>`__ 
* plugins: os-tayga 1.2 `[4] <https://github.com/pfwsense/plugins/blob/stable/22.7/net/tayga/pkg-descr>`__ 
* plugins: os-tor no longer available on LibreSSL due to incompatibilities with newer Tor versions
* plugins: os-web-proxy-useracl is no longer available, no updates since 2017
