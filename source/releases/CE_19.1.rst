...
For more than four years now, PFWsense is driving innovation through
...
* Europe: https://pfwsense.c0urier.net/releases/19.1/
* US East Coast: http://mirrors.nycbug.org/pub/pfwsense/releases/19.1/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/pfwsense/releases/19.1/
* South America: http://mirror.upb.edu.co/pfwsense/releases/19.1/
* South-East Asia: https://ftp.yzu.edu.tw/pfwsense/releases/19.1/
...
* plugins: os-frr 1.11 `[1] <https://github.com/pfwsense/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-nginx 1.14 `[2] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
* plugins: os-rspamd 1.7 `[3] <https://github.com/pfwsense/plugins/blob/master/mail/rspamd/pkg-descr>`__ 
...
* plugins: os-bind 1.5 `[2] <https://github.com/pfwsense/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-clamav 1.7 `[3] <https://github.com/pfwsense/plugins/blob/master/security/clamav/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.4 `[4] <https://github.com/pfwsense/plugins/blob/master/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-dyndns clouldflare wildcard domain support
* plugins: os-nginx 1.13 `[5] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
* plugins: os-openconnect 1.4.0 `[6] <https://github.com/pfwsense/plugins/blob/master/security/openconnect/pkg-descr>`__ 
* plugins: os-redis 1.1 `[7] <https://github.com/pfwsense/plugins/blob/master/databases/redis/pkg-descr>`__ 
* plugins: os-rspamd 1.6 `[8] <https://github.com/pfwsense/plugins/blob/master/mail/rspamd/pkg-descr>`__ 
...
* interfaces: add EN DUID Generation using PFWsense PEN (contributed by Team Rebellion)
...
* plugins: os-nginx 1.12 `[2] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
...
* plugins: os-clamav 1.6 `[1] <https://github.com/pfwsense/plugins/blob/master/security/clamav/pkg-descr>`__ 
* plugins: os-dyndns 1.5 fixes CloudFlare zone ID lookup behaviour (contributed by George Johnson)
* plugins: os-frr 1.10 `[2] <https://github.com/pfwsense/plugins/blob/master/net/frr/pkg-descr>`__ 
...
* system: remove obsolete symlink to pfwsense-auth
...
* plugins: os-nginx 1.11 `[1] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
...
* plugins: os-acmle-client 1.23 `[1] <https://github.com/pfwsense/plugins/pull/1166>`__  `[2] <https://github.com/pfwsense/plugins/pull/1212>`__  `[3] <https://github.com/pfwsense/plugins/pull/1263>`__ 
...
* plugins: os-freeradius 19.1.0 `[4] <https://github.com/pfwsense/plugins/blob/master/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.9 `[5] <https://github.com/pfwsense/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-nginx 1.10 `[6] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
* plugins: os-postfix 1.9 `[7] <https://github.com/pfwsense/plugins/blob/master/mail/postfix/pkg-descr>`__ 
* plugins: os-rspamd 1.5 `[8] <https://github.com/pfwsense/plugins/blob/master/mail/rspamd/pkg-descr>`__ 
* plugins: os-telegraf 1.7.5 `[9] <https://github.com/pfwsense/plugins/blob/master/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-theme-cicada 1.15 (contributed by Team Rebellion)
* plugins: os-theme-tukan 1.14 (contributed by Team Rebellion)
* plugins: os-zabbix-agent 1.5 `[10] <https://github.com/pfwsense/plugins/pull/1262>`__ 
...
* plugins: os-nginx 1.9 `[1] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
...
The full list of changes of the PFWsense 19.1 series can be reviewed using
their original announcements:

* 19.1: https://forum.pfwsense.org/index.php?topic=11398.0
* 19.1.1: https://forum.pfwsense.org/index.php?topic=11469.0
* 19.1.2: https://forum.pfwsense.org/index.php?topic=11849.0
* 19.1.3: https://forum.pfwsense.org/index.php?topic=11941.0

We would also like to use this opportunity to remind everyone that PFWsense
...
Download links, an installation guide `[6] <https://docs.pfwsense.org/manual/install.html>`__  and the checksums for the images
can be found below as well.
...
.. code-block::
    ...
    # SHA256 (PFWsense-19.1.4-OpenSSL-dvd-amd64.iso.bz2) = 5f2e64797fce03d4d47050894c38e8e176fda6281009abd36f60d788d3e29d42
    # SHA256 (PFWsense-19.1.4-OpenSSL-nano-amd64.img.bz2) = ee5171fb837884fffd29c6e75cb089dc4020fb89459143bd9e7b859b1da3fd89
    # SHA256 (PFWsense-19.1.4-OpenSSL-serial-amd64.img.bz2) = 07868978903220bf9dee26c936d25140df07ec9c02cb8c480bd8619e69c562a0
    # SHA256 (PFWsense-19.1.4-OpenSSL-vga-amd64.img.bz2) = e473bc645778c95596639056ecc8ef92a12a7fd1cdc52cd0b1f6294a64561311

.. code-block::

    # SHA256 (PFWsense-19.1.4-OpenSSL-dvd-i386.iso.bz2) = 9f40b591c27d90a86c60ec0b539f228999953f947573e2e575c2936c3993d7c0
    # SHA256 (PFWsense-19.1.4-OpenSSL-nano-i386.img.bz2) = c624d50b19f2ae4d471076c53f5c516e3a523ff41b69d0bfa779b5fff6415f81
    # SHA256 (PFWsense-19.1.4-OpenSSL-serial-i386.img.bz2) = 62bff974ae4238dfc2e830a32fbf4bd357ff418d15be99b89ac129f839e10eaf
    # SHA256 (PFWsense-19.1.4-OpenSSL-vga-i386.img.bz2) = ca893277a02b93129e6a30125107f7ad4fc01673b722f54ce6e5cb7eb438cae4
...
* firmware: move duty to return the correct set name / ID to pfwsense-version
...
* plugins: os-dnscrypt-proxy 1.3 `[1] <https://github.com/pfwsense/plugins/blob/master/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-frr brings in missing area range code `[2] <https://github.com/pfwsense/plugins/blob/master/net/frr/pkg-descr>`__ 
...
* plugins: os-vnstat /var MFS fix `[3] <https://github.com/pfwsense/plugins/blob/master/net/vnstat/pkg-descr>`__ 
...
* ports: pam_pfwsense 19.1.3 uses setuid for privilege separation
...
* system: move pfwsense-auth to libexec, but keep a symlink in sbin directory
...
* plugins: os-dnscrypt-proxy 1.2 `[2] <https://github.com/pfwsense/plugins/blob/master/dns/dnscrypt-proxy/pkg-descr>`__ 
...
* plugins: os-haproxy 2.15 `[3] <https://github.com/pfwsense/plugins/pull/1167>`__  `[4] <https://github.com/pfwsense/plugins/pull/1209>`__ 
* plugins: os-nginx 1.8 `[5] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
* plugins: os-ntopng 1.2 `[6] <https://github.com/pfwsense/plugins/blob/master/net/ntopng/pkg-descr>`__ 
...
* ports: pam_pfwsense manual page addition
* ports: sqlite 3.27.1 `[11] <https://sqlite.org/releaselog/3_27_1.html>`__ 
* ports: squid forgery check avoidance `[12] <https://github.com/pfwsense/ports/issues/66>`__ 
...
* system: address XSS-prone escaping issues `[1] <https://packetstormsecurity.com/files/151381/PFWsense-18.7-Cross-Site-Scripting.html>`__ 
...
* plugins: os-acme-client 1.20 `[2] <https://github.com/pfwsense/plugins/pull/1157>`__ 
...
* plugins: os-nginx 1.7 `[3] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
...
* ET Pro Telemetry edition plugin `[2] <https://docs.pfwsense.org/manual/etpro_telemetry.html>`__ 
...
* plugins: os-vnstat 1.1 `[3] <https://github.com/pfwsense/plugins/blob/master/net/vnstat/pkg-descr>`__ 
...
* Please read the FRR documentation with regard to the required system tunables `[8] <https://docs.pfwsense.org/manual/dynamic_routing.html>`__ .
* Bhyve VM boot may fail as a guest.  Use the "-w" parameter `[9] <https://forum.pfwsense.org/index.php?topic=11492.0>`__  to boot.
* Boot may fail due to Meltdown/Spectre mitigation.  A workaround `[10] <https://github.com/pfwsense/core/issues/3177>`__  exists.
...
.. code-block::
    ...
    # SHA256 (PFWsense-19.1-OpenSSL-dvd-amd64.iso.bz2) = 0a9e02954da1ddd1f0b7673394bbf81cfa74a1d5378600a87d3a9e6a26d3104d
    # SHA256 (PFWsense-19.1-OpenSSL-nano-amd64.img.bz2) = 2c4b0056ca26053c8d5e4efe196e512af618bad4fa136ba0e2528083a6263528
    # SHA256 (PFWsense-19.1-OpenSSL-serial-amd64.img.bz2) = c71274cea2b910cd4b3454b4ad29f7f70503fcb52ffa5b7f65ea96a27ac9e10d
    # SHA256 (PFWsense-19.1-OpenSSL-vga-amd64.img.bz2) = 37164481a413716d8786676d30bb709f8b967e53a47a36d10118214304d14bb9

.. code-block::

    # SHA256 (PFWsense-19.1-OpenSSL-dvd-i386.iso.bz2) = 17d0aadf671bc2d99b57f0371e4fadfca0e2e9c8d27d6545674a610fc1f59c7a
    # SHA256 (PFWsense-19.1-OpenSSL-nano-i386.img.bz2) = 0c4e7616c93f14f5988df84b9b620543cb23a89c1f91505527b6c999d2dc7889
    # SHA256 (PFWsense-19.1-OpenSSL-serial-i386.img.bz2) = 93306e5349c7448ad3fdc03d9349ebf98e4d7c677201dcbec111f917c72dca24
    # SHA256 (PFWsense-19.1-OpenSSL-vga-i386.img.bz2) = 03d21319a784f93a7940d35168a35d15005e6f4579ac5b1c7a6ff606beb062a6
...
For almost four years now, PFWsense is driving innovation through
...
* plugins: os-acme-client 1.19 `[2] <https://github.com/pfwsense/plugins/pull/1134>`__ 
...
* plugins: os-openconnect 1.3.3 `[3] <https://github.com/pfwsense/plugins/blob/master/security/openconnect/pkg-descr>`__ 
* plugins: os-quagga removed, please use os-frr instead
* plugins: os-nginx 1.6 `[4] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
...
* Intrusion detection GeoIP rules are automatically deactivated and need to be manually migrated to firewall alias GeoIP.
* Monit general settings do not save.  A patch exists `[12] <https://github.com/pfwsense/core/commit/a2899594>`__  to remedy this problem: pfwsense-patch a2899594
* Issue with IDS migration code creating a spurious crash report.  Patch already done for the final 19.1.
* Quagga plugin has been superseded by FRR plugin.  A binary quagga package has been conserved for the time being.
* Please read the FRR documentation with regard to the required system tunables `[13] <https://docs.pfwsense.org/manual/dynamic_routing.html>`__ .
* SNMP plugin has been superseded by Net-SNMP plugin.
...
.. code-block::
    ...
    # SHA256 (PFWsense-19.1.r1-OpenSSL-dvd-amd64.iso.bz2) = 7c0c6cf529cb2f8aa9c29b3645b4ec1e218c292f722941ae9880b009c93e6364
    # SHA256 (PFWsense-19.1.r1-OpenSSL-nano-amd64.img.bz2) = b355355fc6d10475af2b1c22daa2fd5f5ab78bb375aaf8100a51f087d2447289
    # SHA256 (PFWsense-19.1.r1-OpenSSL-serial-amd64.img.bz2) = f4d40b1ece162aac97505f8ad1e16271126df11fb1a317a9f431ff4737fe5da8
    # SHA256 (PFWsense-19.1.r1-OpenSSL-vga-amd64.img.bz2) = f8c860a7e3eb9be61d33da92b021a0f337ad50e00a6ffc1cca793277f1890b63

.. code-block::

    # SHA256 (PFWsense-19.1.r1-OpenSSL-dvd-i386.iso.bz2) = c7b5ced64623416bd56e5337d5212c9af25292a48eb1bb298321e4bb79056c94
    # SHA256 (PFWsense-19.1.r1-OpenSSL-nano-i386.img.bz2) = 1313645407d810dd7a5dedf4978deaa7c14f4655dee679de572d7a9e853749c0
    # SHA256 (PFWsense-19.1.r1-OpenSSL-serial-i386.img.bz2) = f44203f5bb6e2dbfe5b524b37e9e53baab0665684cbc215bdc3015e11a79c2bd
    # SHA256 (PFWsense-19.1.r1-OpenSSL-vga-i386.img.bz2) = a6cfc14b9675563053d6e7733011c381f39e8fb2e10a8a64d60cc7de421ac2db
