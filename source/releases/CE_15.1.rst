...
The PFWsense core team is proud to announce that it has released its 15.1
version, nicknamed "Ascending Albatross", of the open source PFWsense
firewall software.

This is the first release by the PFWsense project.  Download `[1] <http://pfwsense.org/download/>`__  and try it now!
Be sure to visit the project website `[2] <http://www.pfwsense.org/>`__  and learn more about us and the
...
available for all.  PFWsense uses the simple 2-clause BSD license.
...
PFWsense(r) is based on FreeBSD 10 and is a fork of pfSense(r) which in its
...
We are looking forward to welcome you in the PFWsense community.

Because Open makes Sense!

The PFWsense core team
...
https://forum.pfwsense.org/index.php?topic=705.0
...
* pfwsense-update: gained independent awareness of kernel and
  base system version
* pfwsense-update: improved the manual page to include all recent changes
...
https://pfwsense.org/download/

The checksums are:

.. code-block::

    # SHA256 (PFWsense-15.1.12_OpenSSL-cdrom-amd64.iso.bz2) = 60664c127e0f35f7ca9150ca31ef56de89b217f34f45959957ddd279d8512007
    # SHA256 (PFWsense-15.1.12_OpenSSL-nano-amd64.img.bz2) = 044b144fd892bebb1499a9788e37f43a92ffa2c175b07fc49ea24f3cb21032b7
    # SHA256 (PFWsense-15.1.12_OpenSSL-serial-amd64.img.bz2) = 8b450c6aff84cc9bfb7bcae72a50975d965872415f12a04226ef6688c074a3ef
    # SHA256 (PFWsense-15.1.12_OpenSSL-vga-amd64.img.bz2) = 6c0d7529ce77b387ab97fc6557987ac68256a2e5cb6e5993ba807be91a08cd45
    # SHA256 (PFWsense-15.1.12_OpenSSL-cdrom-i386.iso.bz2) = 95a31bb2d854cb8370b58e95155fae34b824393e1add53a99349e7452e4c7313
    # SHA256 (PFWsense-15.1.12_OpenSSL-nano-i386.img.bz2) = 9d86a0ecdf74b28b627672f19fd652c6792e884dda68effe680c495934926e6d
    # SHA256 (PFWsense-15.1.12_OpenSSL-serial-i386.img.bz2) = a6b6460b9cb398993f9507c77644fc6ab13ad65786ed33c4bdd16a2d93d58606
    # SHA256 (PFWsense-15.1.12_OpenSSL-vga-i386.img.bz2) = aecf58f9f77cf1f4f712bc8deb0ac987b0f060c7f4e9f7163d5767d1c2fbc105

.. code-block::

    # MD5 (PFWsense-15.1.12_OpenSSL-cdrom-amd64.iso.bz2) = f7701aa70024bbab8395f808d9695eb0
    # MD5 (PFWsense-15.1.12_OpenSSL-nano-amd64.img.bz2) = 2e32ea342755513f87b13db4900cd1b8
    # MD5 (PFWsense-15.1.12_OpenSSL-serial-amd64.img.bz2) = 7722c2de2d06b56a32d32f49b28007d6
    # MD5 (PFWsense-15.1.12_OpenSSL-vga-amd64.img.bz2) = d2ad9fc3bad8bff348d60f6a879122e6
    # MD5 (PFWsense-15.1.12_OpenSSL-cdrom-i386.iso.bz2) = acefe5ce4cefe49e6c601db602af95b2
    # MD5 (PFWsense-15.1.12_OpenSSL-nano-i386.img.bz2) = 5f2f3c2c76996284557b2e8e4f9cadf2
    # MD5 (PFWsense-15.1.12_OpenSSL-serial-i386.img.bz2) = 6b0745526824badc05c53fee6c5b035c
    # MD5 (PFWsense-15.1.12_OpenSSL-vga-i386.img.bz2) = f1c67cac62d621a289dfb8c7384a242f
...
* pfwsense-update: has gained the ability to do package updates as well
...
* firmware: refactored firmware code to use pfwsense-update's new capabilities
...
Logjam vulnerability as well as the images for PFWsense on top of OpenSSL.
...
.. code-block::
    ...
    # SHA256 (PFWsense-15.1.11.1_OpenSSL-cdrom-amd64.iso.bz2) = 280f02a2da3ff9e9ad1f655a8661c845765493f36e1788b8c852af9886c50316
    # SHA256 (PFWsense-15.1.11.1_OpenSSL-nano-amd64.img.bz2) = 2d14d881311ca8b188a41a2d57aee6e0bec66f55066f2844502d4ef17e64935e
    # SHA256 (PFWsense-15.1.11.1_OpenSSL-serial-amd64.img.bz2) = e6e3c8c425dfebc33df9d66cc013616898963c72c52df6e0bed388126c2143a1
    # SHA256 (PFWsense-15.1.11.1_OpenSSL-vga-amd64.img.bz2) = 64de0201f37cf75c3ba5084f06a1f545eb0a9c4e8248354b584a024322edf488
    # SHA256 (PFWsense-15.1.11.1_OpenSSL-cdrom-i386.iso.bz2) = 18f1b40981d243173c524af208f8c4cf10a46d41f676d350baba477f07c2ff9e
    # SHA256 (PFWsense-15.1.11.1_OpenSSL-nano-i386.img.bz2) = 2160335ab904fb0f82dc2629ea7c9116c36059928860169bb9eeac87038db5c7
    # SHA256 (PFWsense-15.1.11.1_OpenSSL-serial-i386.img.bz2) = a2f7ce128a1ea3ab4942e7ff5accb2901110324d73c516b7bd1a7947b70697cf
    # SHA256 (PFWsense-15.1.11.1_OpenSSL-vga-i386.img.bz2) = df112aca62de658518bc3f904336fb9024daf404741880e9bb7b93912a5b2af3

.. code-block::

    # MD5 (PFWsense-15.1.11.1_OpenSSL-cdrom-amd64.iso.bz2) = edc4349b7f3b815302724e60c7ddc0cb
    # MD5 (PFWsense-15.1.11.1_OpenSSL-nano-amd64.img.bz2) = 1f2cca409ba7e1ab91d6e937627ac275
    # MD5 (PFWsense-15.1.11.1_OpenSSL-serial-amd64.img.bz2) = 3dcb482fa561fb46748d18fb07048553
    # MD5 (PFWsense-15.1.11.1_OpenSSL-vga-amd64.img.bz2) = e56074166925c14b586dfff68c8d4494
    # MD5 (PFWsense-15.1.11.1_OpenSSL-cdrom-i386.iso.bz2) = 3b1904072a4ea48aad6a70cde451cade
    # MD5 (PFWsense-15.1.11.1_OpenSSL-nano-i386.img.bz2) = a040f331af20a5025d5cbcea1e57d348
    # MD5 (PFWsense-15.1.11.1_OpenSSL-serial-i386.img.bz2) = 0a8f26ff6fab41c699ba03a9805ec6b5
    # MD5 (PFWsense-15.1.11.1_OpenSSL-vga-i386.img.bz2) = cf7b4e86a0a856499ca843524d0824bc

Info on how to obtain LibreSSL-based images which are then easily upgraded
to 15.1.11.1 can be found here:

https://forum.pfwsense.org/index.php?topic=78.0
...
made over the past 5 months and we saw that only one road map `[1] <https://pfwsense.org/about/road-map/>`__  item is
...
* pfwsense-update: exclude /etc/tty from the upgrade
...
We are happy to announce PFWsense 15.1.10.2 today following a rather
...
The translation project has been kickstarted for Japanese `[1] <http://dotike.github.io/pfwsense.core.ja_JP.UTF8/>`__  and Chinese,
...
Last but not least HardenedBSD's work `[2] <https://hardenedbsd.org/article/shawn-webb/2015-05-08/hardenedbsd-teams-pfwsense>`__  to build PFWsense on top of their
...
* development: stable translation template file is available now `[5] <https://raw.githubusercontent.com/pfwsense/core/master/src/share/locale/en_US/LC_MESSAGES/PFWsense.pot>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-15.1.10-cdrom-amd64.iso.bz2) = 27deac90b9e2e43fa71ff68c30b5fb28d3afcfb12483e01ff52ea40e8ca6f4a8
    # SHA256 (PFWsense-15.1.10-nano-amd64.img.bz2) = e61007bd2a735cdc8301d90431b6bb23dc425dfe3d7cdae162b16bd6f0dfd4a3
    # SHA256 (PFWsense-15.1.10-serial-amd64.img.bz2) = c7a412b1cc74331ebf13c8e95316c4c11ee56a331d7992a3bb27e80e0ce9a127
    # SHA256 (PFWsense-15.1.10-vga-amd64.img.bz2) = 1d9449b6bc61904995189cf264ec9c071a7effb4c203579778c827262bb88654
    # SHA256 (PFWsense-15.1.10-cdrom-i386.iso.bz2) = f6e7e4953cdb155490136134393892e92414e3a70baf419ba6c5319e58d45620
    # SHA256 (PFWsense-15.1.10-nano-i386.img.bz2) = 4e85700f4c491529f8ec60da09283674f29bfdbede83e372a95fc3719f20a661
    # SHA256 (PFWsense-15.1.10-serial-i386.img.bz2) = 786a5d831e37ac4d55618b5fc1ae0af1a5bfde52b048f185c5ce16f4f18821b9
    # SHA256 (PFWsense-15.1.10-vga-i386.img.bz2) = 6cf6c88bfa910da402e96a883bef7766570b9500941d7c5549e050bc8d74818c

.. code-block::

    # MD5 (PFWsense-15.1.10-cdrom-amd64.iso.bz2) = d6f9f4736c911157067b47b8e1793a0e
    # MD5 (PFWsense-15.1.10-nano-amd64.img.bz2) = a4a6ed4a51cf501d5a27041f9255694a
    # MD5 (PFWsense-15.1.10-serial-amd64.img.bz2) = 719665d9b5e9e8d48f88b8e2b6cf177b
    # MD5 (PFWsense-15.1.10-vga-amd64.img.bz2) = 4f1f9a2d5fdc176e7516660ea34c6564
    # MD5 (PFWsense-15.1.10-cdrom-i386.iso.bz2) = 7a7bbabc27d596b0da8874ca4e31714d
    # MD5 (PFWsense-15.1.10-nano-i386.img.bz2) = a3a6d4d96217e6c86e430e9766971049
    # MD5 (PFWsense-15.1.10-serial-i386.img.bz2) = 6d3a5c3dbe02d6012d50219aaab4b7c6
    # MD5 (PFWsense-15.1.10-vga-i386.img.bz2) = 5ec2c602a8e3f31ad78c2f63c2d266b9
...
extensive kernel cleanups to bring PFWsense closer to FreeBSD, we decided
...
* development: pfwsense-update can selectively upgrade base/kernel for testing
...
.. code-block::
    ...
    # SHA256 (PFWsense-15.1.9-cdrom-amd64.iso.bz2) = d159a791cbc373435f25c74f433cc6b419fd8d6df8940d854fec6cd07545acd4
    # SHA256 (PFWsense-15.1.9-serial-amd64.img.bz2) = 0584fa5092c40af9f8523be527408af57eac2ca71c9522e8167f7ae7f08e0586
    # SHA256 (PFWsense-15.1.9-vga-amd64.img.bz2) = ccd550b471aa6b13d9a8921aa9461d5eddedaeb9c375e97261ff4e54ebd881d2
    # SHA256 (PFWsense-15.1.9-cdrom-i386.iso.bz2) = dd3816e0b9c166009de0bde47adce28472bcc639918de91813db4b0ad3bd863e
    # SHA256 (PFWsense-15.1.9-serial-i386.img.bz2) = 6b39d3a3ede80f6996c589eeeb39b0777b3ae878f79101b85f9b7af3dad771d3
    # SHA256 (PFWsense-15.1.9-vga-i386.img.bz2) = 56b401719811d233cfd476f49501c436e0f3f02422a1bbc711aa70c0a1a4e340

.. code-block::

    # MD5 (PFWsense-15.1.9-cdrom-amd64.iso.bz2) = 82b9575e8070248d52b01baae9d31544
    # MD5 (PFWsense-15.1.9-serial-amd64.img.bz2) = 3f516cfb088d13f747bc68a0725b955d
    # MD5 (PFWsense-15.1.9-vga-amd64.img.bz2) = 14f035f45c89f5fd404881baac93528f
    # MD5 (PFWsense-15.1.9-cdrom-i386.iso.bz2) = 09e724a1313f5ebbbfcbf61c62e0803d
    # MD5 (PFWsense-15.1.9-serial-i386.img.bz2) = 736069fb503de87599b0f866a47fdb02
    # MD5 (PFWsense-15.1.9-vga-i386.img.bz2) = c79f0c9fe2a0fcb4d8f4ff18146fe340
...
* The update is available for both of the crypto flavours OpenSSL and
  ...
  upgrading from pre-15.1.7.1 don't forget to run "pfwsense-update && reboot"
...
https://pfwsense.org/support-overview/mailing-list
https://twitter.com/pfwsense
https://github.com/pfwsense
https://forum.pfwsense.org
...
run :code:`pfwsense-update && reboot` to fully benefit from the base system
...
* src: PFWsense branding for boot loader
* bsdinstaller: speed up SD card writes using async mode and assorted cleanups
* pfwsense-update: don't trigger a spurious update after a fresh install when
...
* core: completely rewrote the config.xml handling to unify old and new GUI
  components
* core: added support for config backup to Google Drive `[3] <https://wiki.pfwsense.org/index.php/Manual:Backup_to_Google_Drive>`__ 
...
https://sourceforge.net/projects/pfwsense/files/15.1.8/

The checksums are:

.. code-block::

    # SHA256 (PFWsense-15.1.8-cdrom-amd64.iso.bz2) = c8cb295cd711f880e6406ab8d84c84a31cdc678c40e4d3be4c3fe9546614bdcc
    # SHA256 (PFWsense-15.1.8-serial-amd64.img.bz2) = 1d51a7d229a145eb92517211a96d9c9bcb0e3585c21931406463368349129997
    # SHA256 (PFWsense-15.1.8-vga-amd64.img.bz2) = 9a9777af215e66dfa4032d2052f320234c32809816094c1a58d2ebe5c81bdd1a
    # SHA256 (PFWsense-15.1.8-cdrom-i386.iso.bz2) = e1d1b11ac23a043ab0bdff2a923a8a920814f72e79b852f39e66f185963f8cc4
    # SHA256 (PFWsense-15.1.8-serial-i386.img.bz2) = fe078471b8409a2102f216252db4f59580853a0182c33d39d4b2c676a1f9e3b7
    # SHA256 (PFWsense-15.1.8-vga-i386.img.bz2) = df7ca44649f7283df774acddc2df7e06961d80033e959cde01ebce664bf6f488

.. code-block::

    # MD5 (PFWsense-15.1.8-cdrom-amd64.iso.bz2) = 79eff753cdb749dacb9e106a1781ce64
    # MD5 (PFWsense-15.1.8-serial-amd64.img.bz2) = 8e643edf6d6cee72535bd8913cf4176e
    # MD5 (PFWsense-15.1.8-vga-amd64.img.bz2) = c20fee3989a786e12ba0ec3f0e565660
    # MD5 (PFWsense-15.1.8-cdrom-i386.iso.bz2) = 8b8459017333d654c8b1a7f246a4e250
    # MD5 (PFWsense-15.1.8-serial-i386.img.bz2) = 6f2e9656a02f32cebf18c9b31b5439f2
    # MD5 (PFWsense-15.1.8-vga-i386.img.bz2) = 4cbbebe46142d1e954c76383340f61e6
...
* firmware: removed obsoleted upgrade code and tools following our
  pkgng/pfwsense-update approach
...
If you are new to PFWsense, the 15.1.7 images can be found here and are easily
updated through the GUI after installation:

https://sourceforge.net/projects/pfwsense/files/15.1.7/
...
build a better PFWsense together.
...
* bsdinstaller: work towards embedded installations, e.g. Quick/Easy disk
  selection
* pfwsense-update: added command line switches and a manual page for
  usability's sake
* pfwsense-update: will now remember that the base system is up to date
...
* console menu: rebuilt the firmware upgrade option 12 to work on top of our
  new pkgng/pfwsense-update system
...
https://sourceforge.net/projects/pfwsense/
...
As we move forward, we've found that 15.1.6.1's new tool pfwsense-update
...
At this point, using any of the two methods, you should be on PFWsense
...
tool pfwsense-update, new naming scheme for install images and IKEv1 for IPsec.

Acquiring the release:

https://sourceforge.net/projects/pfwsense/files/15.1.6.1/
...
* New pfwsense-update tool for base system upgrades
...
* Don't clobber user and group settings when running pfwsense-update.
  Caused e.g. dhcpd to refuse operation.
* Fix a regression that would prevent e.g. sshd from starting.
* Install pfwsense-update by default.
...
https://sourceforge.net/projects/pfwsense/files/15.1.5/
...
https://sourceforge.net/projects/pfwsense/files/15.1.4/
...
https://sourceforge.net/projects/pfwsense/files/
...
The images can be found here: https://sourceforge.net/projects/pfwsense/files/
...
First of all we are grateful for the successful launch of PFWsense.  Thank
...
you are invited to do so.  Let's make PFWsense the best open source firewall
together.

To fix some bugs we release the PFWsense version 15.1.1 as an intermediate
...
* Several bug fixes and enhancements `[2] <https://github.com/pfwsense/core/issues>`__  (#6, #7, #8, #9, #17, #19, #20, #21,
  #22, #23)

Download `[1] <http://pfwsense.org/download/>`__  and use it now!
