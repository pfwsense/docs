...
For 3 and a half years now, PFWsense is driving innovation through
...
* ZFS on root boot support (installer support is pending, but pfwsense-bootstrap works)
...
* Europe: https://pfwsense.c0urier.net/releases/18.7/
* US East Coast: http://mirrors.nycbug.org/pub/pfwsense/releases/18.7/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/pfwsense/releases/18.7/
* South America: http://mirror.upb.edu.co/pfwsense/releases/18.7/
* South-East Asia: https://ftp.yzu.edu.tw/pfwsense/releases/18.7/
...
* firmware: migrate more scripting to pfwsense-version
...
* plugins: os-bind 1.4 `[1] <https://github.com/pfwsense/plugins/blob/master/dns/bind/pkg-descr>`__  (contributed by Michael Muenz)
...
* plugins: os-haproxy 2.13 `[2] <https://github.com/pfwsense/plugins/pull/1090>`__  (contributed by Frank Wall)
...
* plugins: os-postfix 1.8 `[3] <https://github.com/pfwsense/plugins/blob/master/mail/postfix/pkg-descr>`__  (contributed by Michael Muenz)
...
* firmware: pfwsense-version can now handle kernel, base and plugin metadata
...
* plugins: os-nginx 1.5 with lots of new features `[1] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__  (contributed by Fabian Franz, Carlos Cesario, Julio Cesar Camargo, fzoske)
...
* plugins: os-haproxy 2.10 `[1] <https://github.com/pfwsense/plugins/pull/960>`__  `[2] <https://github.com/pfwsense/plugins/pull/970>`__  `[3] <https://github.com/pfwsense/plugins/pull/1003>`__  (contributed by Frank Wall)
...
* plugins: os-zabbix-agent 1.4 `[4] <https://github.com/pfwsense/plugins/pull/998>`__  (contributed by Frank Wall)
...
* system: do not offer root-only pfwsense-shell to non-root users
...
* firmware: use pfwsense-version where appropriate
...
* plugins: os-nginx 1.2 `[1] <https://github.com/pfwsense/plugins/commit/6776a5a17>`__  (contributed by Fabian Franz)
...
* firmware: introduce pfwsense-version utility and fully template build metadata
...
* plugins: os-haproxy 2.8 `[1] <https://github.com/pfwsense/plugins/pull/772>`__  (contributed by Frank Wall)
...
* SSH access is now bound to the "wheel" group which is automatically
  ...
  only user that has a default shell, namely pfwsense-shell, which is the
  root console menu.
...
.. code-block::
    ...
    # SHA256 (PFWsense-18.7-OpenSSL-dvd-amd64.iso.bz2) = 6b3528f8dea8de5c96de5547636fd51c40382c245b30eb215608acbd04fb7e91
    # SHA256 (PFWsense-18.7-OpenSSL-nano-amd64.img.bz2) = cb0272f0bd945ea8070d9a40af2cd47a3b68e9bd389395b285bb9ab4128d1f00
    # SHA256 (PFWsense-18.7-OpenSSL-serial-amd64.img.bz2) = a4556080532d22e9ab296e2c6e163b3d65d5fe54a642253e1c01a22721afa850
    # SHA256 (PFWsense-18.7-OpenSSL-vga-amd64.img.bz2) = 4408840fba4177d44503968fce44d8ca7180003728660fd9c0a2e6920346008c

.. code-block::

    # SHA256 (PFWsense-18.7-OpenSSL-dvd-i386.iso.bz2) = 8ea49dcb512365a1e92e94fb38f1b4a85463ffacfb98c055e84e6340a6321ecf
    # SHA256 (PFWsense-18.7-OpenSSL-nano-i386.img.bz2) = bdd753a63367944452d2d5d1e73e4aa9f3d607012d10c4274420d23867a4fbad
    # SHA256 (PFWsense-18.7-OpenSSL-serial-i386.img.bz2) = f74f5fd1c24cc54002fa9b99a0c10b4402b3f748a315ff302126acb154cd2633
    # SHA256 (PFWsense-18.7-OpenSSL-vga-i386.img.bz2) = 52208b57f9e89d235411df33faac71b8d9872d50947ff4c0dca6f552424a4d95
...
* installer: use pfwsense-importer on configuration import to avoid code duplication
...
* rc: redesigned rc.initial as pfwsense-shell utility with command line support and improved RC system interoperability
...
.. code-block::
    ...
    # SHA256 (PFWsense-18.7.r1-OpenSSL-dvd-amd64.iso.bz2) = c5ca07eefde68d16d0fc060fd2fa0be12d77752d5376b5483103c8d1901975ca
    # SHA256 (PFWsense-18.7.r1-OpenSSL-nano-amd64.img.bz2) = c2252d379c10936f98ed02044dc61eda13b8b3ffe08c0e9e7f0a70a462fcb005
    # SHA256 (PFWsense-18.7.r1-OpenSSL-serial-amd64.img.bz2) = f48a065e8e6d0ed8f38737d46d991df4c231ef5ce60f022eb2252a41e55842fe
    # SHA256 (PFWsense-18.7.r1-OpenSSL-vga-amd64.img.bz2) = 4d6237590df8cb918fff580f7cf6fed08a9b1fbd224061870bf7e4cf4e394c18

.. code-block::

    # SHA256 (PFWsense-18.7.r1-OpenSSL-dvd-i386.iso.bz2) = 3fc4405619763cdcf08620a029a1d5270271b2e796af7e4b8869995e28ad4f68
    # SHA256 (PFWsense-18.7.r1-OpenSSL-nano-i386.img.bz2) = 1efc4695be64cfee87603cea77d6e89b8b09c33fa1a491d15f0b652234c1f21a
    # SHA256 (PFWsense-18.7.r1-OpenSSL-serial-i386.img.bz2) = f010ca0d33addeb94f436a551a61418f95fde9bd7511c88b75a7131ca65b162f
    # SHA256 (PFWsense-18.7.r1-OpenSSL-vga-i386.img.bz2) = aba557b88ae27ecd5d301fa32f3910a7e5499491b8263e21a722976c0da714fc
