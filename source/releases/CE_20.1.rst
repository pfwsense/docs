...
For over 5 years now, PFWsense is driving innovation through modularising
...
* Europe: https://pfwsense.c0urier.net/releases/20.1/
* US East Coast: http://mirrors.nycbug.org/pub/pfwsense/releases/20.1/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/pfwsense/releases/20.1/
* South America: http://mirror.upb.edu.co/pfwsense/releases/20.1/
* South-East Asia: https://ftp.yzu.edu.tw/pfwsense/releases/20.1/
...
* plugins: os-collectd 1.3 `[1] <https://github.com/pfwsense/plugins/blob/stable/20.1/net-mgmt/collectd/pkg-descr>`__ 
* plugins: os-dyndns 1.22 `[2] <https://github.com/pfwsense/plugins/pull/1654>`__ 
* plugins: os-telegraf 1.8.1 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.1/net-mgmt/telegraf/pkg-descr>`__ 
* plugins: os-theme-rebellion 1.8.6 (contributed by Team Rebellion)
* plugins: os-tinc fixes switch mode `[4] <https://github.com/pfwsense/plugins/pull/1733>`__ 
* plugins: os-wireguard 1.2 `[5] <https://github.com/pfwsense/plugins/pull/1865>`__ 
...
* plugins: os-acme-client `[1] <https://github.com/pfwsense/plugins/pull/1851>`__  `[2] <https://github.com/pfwsense/plugins/pull/1880>`__ 
* plugins: os-dnscrypt-proxy 1.8 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.1/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-dyndns 1.21 improves Cloudflare support (contributed by Andreas Rupper)
* plugins: os-freeradius 1.9.7 `[4] <https://github.com/pfwsense/plugins/pull/1726>`__ 
* plugins: os-haproxy 2.23 `[5] <https://github.com/pfwsense/plugins/pull/1883>`__ 
* plugins: os-intrusion-detection-content-snort-vrt 1.1
* plugins: os-stunnel 1.0 `[6] <https://docs.pfwsense.org/manual/how-tos/stunnel.html>`__  (sponsored by Incenter Technology)
* plugins: os-tayga 1.1 `[7] <https://github.com/pfwsense/plugins/pull/1826>`__ 
* plugins: os-theme-rebellion 1.8.4 `[8] <https://github.com/pfwsense/plugins/pull/1892>`__ 
...
* firmware: use CORE_FLAVOUR instead of FLAVOUR when using pfwsense-bootstrap
* firmware: enable to optionally reach master branch when using pfwsense-boostrap
* firmware: allow overriding CORE_ABI when using pfwsense-bootstrap
* firmware: copy make.conf instead of linking when using pfwsense-code
* firmware: always fetch tools.git when using pfwsense-code
...
* plugins: os-acme-client 1.31 `[1] <https://github.com/pfwsense/plugins/pull/1784>`__ 
* plugins: os-firewall 1.0 API supplemental package
* plugins: os-haproxy 2.22 `[2] <https://github.com/pfwsense/plugins/pull/1783>`__ 
* plugins: os-unbound-plus 1.1 `[3] <https://github.com/pfwsense/plugins/blob/master/dns/unbound-plus/pkg-descr>`__ 
...
* firmware: mirror pfwsense.ieji.de renamed to opn.sense.nz
...
* plugins: os-acme-client 1.30 `[1] <https://github.com/pfwsense/plugins/pull/1753>`__ 
* plugins: os-bind 1.13 `[2] <https://github.com/pfwsense/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-freeradius 1.9.6 `[3] <https://github.com/pfwsense/plugins/blob/master/net/freeradius/pkg-descr>`__ 
* plugins: os-haproxy 2.21 `[4] <https://github.com/pfwsense/plugins/pull/1755>`__ 
* plugins: os-maltrail 1.5 `[5] <https://github.com/pfwsense/plugins/blob/master/security/maltrail/pkg-descr>`__ 
* plugins: os-nginx 1.19 `[6] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
* plugins: os-nut 1.7 `[7] <https://github.com/pfwsense/plugins/blob/master/sysutils/nut/pkg-descr>`__ 
* plugins: os-postfix 1.14 `[8] <https://github.com/pfwsense/plugins/blob/master/mail/postfix/pkg-descr>`__ 
* plugins: os-tayga 1.0 (contributed by Michael Muenz)
* plugins: os-telegraf 1.7.7 `[9] <https://github.com/pfwsense/plugins/blob/master/net-mgmt/telegraf/pkg-descr>`__ 
...
* plugins: os-maltrail 1.4 `[1] <https://github.com/pfwsense/plugins/blob/master/security/maltrail/pkg-descr>`__ 
...
* plugins: os-dnscrypt-proxy 1.7 `[1] <https://github.com/pfwsense/plugins/blob/master/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-net-snmp 1.4 `[2] <https://github.com/pfwsense/plugins/blob/master/net-mgmt/net-snmp/pkg-descr>`__ 
* plugins: os-nginx 1.18 `[3] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
...
* plugins: os-vnstat 1.2 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.1/net/vnstat/pkg-descr>`__ 
* plugins: zabbix4-proxy 1.2 `[4] <https://github.com/pfwsense/plugins/blob/stable/20.1/net-mgmt/zabbix4-proxy/pkg-descr>`__ 
...
* To prevent stale configuration files for remote syslog we advise to setup the new targets first `[9] <https://docs.pfwsense.org/manual/settingsmenu.html#logging-targets>`__  and disable the old ones under System: Settings: Logging
...
.. code-block::
    ...
    # SHA256 (PFWsense-20.1-OpenSSL-dvd-amd64.iso.bz2) = 4b15e9b3d72732d325c5eaf46ba34575d4de8cdc3e3ac1b10666c7372563be6d
    # SHA256 (PFWsense-20.1-OpenSSL-nano-amd64.img.bz2) = 27544a78ae03d480a483cfd2e7cfa703b60e50938a1ed188ec3ccde6c426fefe
    # SHA256 (PFWsense-20.1-OpenSSL-serial-amd64.img.bz2) = f93bbcbe92059c5de49f22d485da292952b48658a28d1cdaf83191e8c95c03c2
    # SHA256 (PFWsense-20.1-OpenSSL-vga-amd64.img.bz2) = 019a877c4b4cb96cfda62d041774a91c030c5a8ecd58f8c3fd0067c7ac392982

.. code-block::

    # SHA256 (PFWsense-20.1-OpenSSL-dvd-i386.iso.bz2) = 36146d0a066d9d696433599487e2a538ee5575a6b3d631293ad9e14e5fbbc6e0
    # SHA256 (PFWsense-20.1-OpenSSL-nano-i386.img.bz2) = 0980f49d1b3445505fd1db27ab070886a706388d3aa16d7c8d953f279b7e3b11
    # SHA256 (PFWsense-20.1-OpenSSL-serial-i386.img.bz2) = 322adbafe331ef7232c08d839a6f355ee633f5a662009b1801ebad0edab03d73
    # SHA256 (PFWsense-20.1-OpenSSL-vga-i386.img.bz2) = 8bdd109015d7d54d382c7293bdf8fac6397a6c2e37662b73647c276e98c19d64
...
* system: pfwsense-auth can now respond with extended properties in JSON on successful authentication
...
* plugins: os-haproxy 2.20 `[2] <https://github.com/pfwsense/plugins/pull/1646>`__ 
* plugins: os-zabbix-agent 1.7 `[3] <https://github.com/pfwsense/plugins/pull/1578>`__  `[4] <https://github.com/pfwsense/plugins/pull/1618>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-20.1.r1-OpenSSL-dvd-amd64.iso.bz2) = fed43e5cc5092da5adcfcb2ccdddf51a1cea6a69f06b764fcd9c3d36e0705d4a
    # SHA256 (PFWsense-20.1.r1-OpenSSL-nano-amd64.img.bz2) = bf825455cc09e2a410cbe702a0c1c5b454546c476c7e90ae87ab64fc3eee6a78
    # SHA256 (PFWsense-20.1.r1-OpenSSL-serial-amd64.img.bz2) = 906103fb4cc3e573a9e2d560a6365baa7162077b8933a253bb45fd23a154dd87
    # SHA256 (PFWsense-20.1.r1-OpenSSL-vga-amd64.img.bz2) = 3308412597f5b95f9b9e854ddbeb5f49735109d846af553dbe2553dedf73cb9b

.. code-block::

    # SHA256 (PFWsense-20.1.r1-OpenSSL-dvd-i386.iso.bz2) = a110e2ed48228d918909daca5d93d8acafccdc4426e3e928d8561f7ad4180289
    # SHA256 (PFWsense-20.1.r1-OpenSSL-nano-i386.img.bz2) = 201b757b0d719e8f3c4aa473b414005a5544a4b1553ca9d79c1743610d67b460
    # SHA256 (PFWsense-20.1.r1-OpenSSL-serial-i386.img.bz2) = 74a8f6bc5cdf885f5ff906ad2dfd05584f8e217212f90cd2e3a3269a5a9b604a
    # SHA256 (PFWsense-20.1.r1-OpenSSL-vga-i386.img.bz2) = 1779ca5aeb37d2d97bd7e053421d64206b27189db74711600b93e458d858caff
