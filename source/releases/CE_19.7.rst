...
For four and a half years now, PFWsense is driving innovation through
...
party software to up-to-date releases, PFWsense now also offers built-in
...
* Europe: https://pfwsense.c0urier.net/releases/19.7/
* US East Coast: http://mirrors.nycbug.org/pub/pfwsense/releases/19.7/
* US West Coast: https://mirror.sfo12.us.leaseweb.net/pfwsense/releases/19.7/
* South America: http://mirror.upb.edu.co/pfwsense/releases/19.7/
* South-East Asia: https://ftp.yzu.edu.tw/pfwsense/releases/19.7/
...
* plugins: os-haproxy 2.20 `[1] <https://github.com/pfwsense/plugins/pull/1646>`__ 
* plugins: os-mail-backup 1.1 `[2] <https://github.com/pfwsense/plugins/pull/1671>`__ 
* plugins: os-nrpe 1.0 (contributed by Michael Muenz)
* plugins: os-theme-rebellion 1.8.3 (contributed by Team Rebellion)
* plugins: os-vnstat 1.2 `[3] <https://github.com/pfwsense/plugins/blob/master/net/vnstat/pkg-descr>`__ 
* plugins: zabbix4-proxy 1.2 `[4] <https://github.com/pfwsense/plugins/blob/master/net-mgmt/zabbix4-proxy/pkg-descr>`__ 
...
* firewall: new GeoIP settings page to allow continued use of upstream database `[1] <https://docs.pfwsense.org/manual/how-tos/maxmind_geo_ip.html>`__ 
...
* plugins: os-acme-client 1.29 `[2] <https://github.com/pfwsense/plugins/pull/1638>`__ 
* plugins: os-bind 1.12 `[3] <https://github.com/pfwsense/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-dyndns must use dyndns_failover_interface() to translate gateway group
* plugins: os-frr 1.14 `[4] <https://github.com/pfwsense/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-maltrail 1.3 `[5] <https://github.com/pfwsense/plugins/blob/master/security/maltrail/pkg-descr>`__ 
* plugins: os-nginx 1.17 `[6] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
...
* plugins: os-zabbix4-proxy 1.1 `[7] <https://github.com/pfwsense/plugins/blob/master/net-mgmt/zabbix4-proxy/pkg-descr>`__ 
...
* firmware: use pfwsense-revert in GUI reinstall package case
...
* plugins: os-bind 1.11 `[1] <https://github.com/pfwsense/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-dyndns 1.18 adds Linode support (contributed by Andrew Gunnerson)
* plugins: os-freeradius 1.9.5 `[2] <https://github.com/pfwsense/plugins/blob/master/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.13 `[3] <https://github.com/pfwsense/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-ftp-proxy style updates only
* plugins: os-postfix 1.13 `[4] <https://github.com/pfwsense/plugins/blob/master/mail/postfix/pkg-descr>`__ 
* plugins: os-rspamd 1.9 `[5] <https://github.com/pfwsense/plugins/blob/master/mail/rspamd/pkg-descr>`__ 
...
* mvc: fix forceReload()
* plugins: os-acme-client 1.28 `[1] <https://github.com/pfwsense/plugins/pull/1565>`__ 
* plugins: os-bind 1.10 `[2] <https://github.com/pfwsense/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-nginx 1.16 `[3] <https://github.com/pfwsense/plugins/blob/master/www/nginx/pkg-descr>`__ 
* plugins: os-nut 1.6 `[4] <https://github.com/pfwsense/plugins/blob/master/sysutils/nut/pkg-descr>`__ 
* plugins: os-postfix 1.12 `[5] <https://github.com/pfwsense/plugins/blob/master/mail/postfix/pkg-descr>`__ 
...
* plugins: os-acme-client 1.27 `[1] <https://github.com/pfwsense/plugins/pull/1536>`__ 
* plugins: os-bind 1.9 `[2] <https://github.com/pfwsense/plugins/blob/stable/20.1/dns/bind/pkg-descr>`__ 
* plugins: os-nginx 1.15 `[3] <https://github.com/pfwsense/plugins/blob/stable/20.1/www/nginx/pkg-descr>`__ 
...
* plugins: os-acme-client 1.26 `[1] <https://github.com/pfwsense/plugins/pull/1499>`__ 
...
* plugins: os-freeradius 1.9.4 `[2] <https://github.com/pfwsense/plugins/blob/master/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.12 `[3] <https://github.com/pfwsense/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-haproxy 2.19 `[4] <https://github.com/pfwsense/plugins/pull/1498>`__ 
* plugins: os-mailtrail 1.2 `[5] <https://github.com/pfwsense/plugins/blob/master/security/maltrail/pkg-descr>`__ 
* plugins: os-postfix 1.11 `[6] <https://github.com/pfwsense/plugins/blob/master/mail/postfix/pkg-descr>`__ 
* plugins: os-rspamd 1.8 `[7] <https://github.com/pfwsense/plugins/blob/master/mail/rspamd/pkg-descr>`__ 
* plugins: os-sunnyvalley LibreSSL support (contributed by Sunny Valley Networks)
* plugins: os-telegraf 1.7.6 `[8] <https://github.com/pfwsense/plugins/blob/master/net-mgmt/telegraf/pkg-descr>`__ 
...
take a closer look `[1] <https://pfwsense.org/about/road-map/>`__ .  More exciting for sure.  :)
...
* plugins: os-bind 1.8 `[2] <https://github.com/pfwsense/plugins/blob/master/dns/bind/pkg-descr>`__  (contributed by ErikJStaab)
* plugins: os-dnscrypt-proxy 1.6 `[3] <https://github.com/pfwsense/plugins/blob/master/dns/dnscrypt-proxy/pkg-descr>`__  (contributed by ErikJStaab)
* plugins: os-etpro-telemetry 1.4 `[4] <https://docs.pfwsense.org/manual/etpro_telemetry.html>`__ 
...
* firmware: only do single-repository fingerprint verify defaulting to our PFWsense repository
...
* plugins: os-acme-client 1.25 `[1] <https://github.com/pfwsense/plugins/pull/1452>`__ 
* plugins: os-bind 1.7 `[2] <https://github.com/pfwsense/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-dyndns 1.17 removes OpenDNS and fixes DyNS
* plugins: os-haproxy 2.18 `[3] <https://github.com/pfwsense/plugins/pull/1453>`__ 
* plugins: os-maltrail 1.1 `[4] <https://github.com/pfwsense/plugins/blob/master/security/maltrail/pkg-descr>`__ 
* plugins: os-nginx log rotation fix (contributed by Fabian Franz)
* plugins: os-postfix 1.10 `[5] <https://github.com/pfwsense/plugins/blob/master/mail/postfix/pkg-descr>`__ 
...
* plugins: os-wireguard 1.1 `[6] <https://github.com/pfwsense/plugins/blob/master/net/wireguard/pkg-descr>`__ 
...
* plugins: os-grid_example 1.0 `[1] <https://docs.pfwsense.org/development/examples/using_grids.html>`__ 
* plugins: os-helloworld Python 3 compatibility `[2] <https://docs.pfwsense.org/development/examples/helloworld.html>`__ 
* plugins: os-nut 1.5 adds Riello driver (contributed by Michael Muenz)
* plugins: os-sunnyvalley 1.0 `[3] <https://docs.pfwsense.org/third_party_plugins.html>`__  `[4] <https://www.sunnyvalley.io/sensei>`__ 
...
* plugins: os-acme-client 1.24 `[1] <https://github.com/pfwsense/plugins/pull/1399>`__ 
* plugins: os-bind 1.6 `[2] <https://github.com/pfwsense/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.5 `[3] <https://github.com/pfwsense/plugins/blob/master/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-frr now restricts characters BGP prefix-list and route-maps `[4] <https://github.com/pfwsense/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-google-cloud-sdk 1.0 `[5] <https://github.com/pfwsense/plugins/pull/1392>`__ 
...
* Improved reliability and utility of pfwsense-patch
...
* plugins: os-haproxy 2.17 `[2] <https://github.com/pfwsense/plugins/pull/1347>`__  `[3] <https://github.com/pfwsense/plugins/pull/1408>`__ 
...
.. code-block::
    ...
    # SHA256 (PFWsense-19.7-OpenSSL-dvd-amd64.iso.bz2) = e022217d367abaf4fd1360f83e4664d28b3f37932dfe720974b9d7dc33bf50f7
    # SHA256 (PFWsense-19.7-OpenSSL-nano-amd64.img.bz2) = 6fffefa0b09daea397e83f67bf730392125b720043c455597c05d3d80c2baa29
    # SHA256 (PFWsense-19.7-OpenSSL-serial-amd64.img.bz2) = 98854d5a0a03850273aa2ebdd7e7b095dfec6a1e6b57341817bb5f5ffab2ca7b
    # SHA256 (PFWsense-19.7-OpenSSL-vga-amd64.img.bz2) = 523e924586e431ccd421bb85ba1245ce4c8f3a6141b59623f5083d3e36bac592

.. code-block::

    # SHA256 (PFWsense-19.7-OpenSSL-dvd-i386.iso.bz2) = 64c4e58966ab373a0aa6a544b020a39c5b86ecb79cb2988ac1f74b382c7d4765
    # SHA256 (PFWsense-19.7-OpenSSL-nano-i386.img.bz2) = 3fa6af965f5996a718982617b5a13199747d237a669867b1ffecc951c3ebe455
    # SHA256 (PFWsense-19.7-OpenSSL-serial-i386.img.bz2) = f0c76142f83b4988defa3fddc7a4cf2d930cbb0aee623d7b064462e25e146297
    # SHA256 (PFWsense-19.7-OpenSSL-vga-i386.img.bz2) = b425882604886a395730abeaa6a26b8805647609712f61c342cee29f58160006
...
* installer: support password reset in pfwsense-importer
...
.. code-block::
    ...
    # SHA256 (PFWsense-19.7.r1-OpenSSL-dvd-amd64.iso.bz2) = 5014dba896a425d15fbedcb44f2deec7fb5aee6a1b7c95833b819f8d352de6a1
    # SHA256 (PFWsense-19.7.r1-OpenSSL-nano-amd64.img.bz2) = b9d6ccbfdcb88f813a6494efb13647d1715500551c7dc51f632766b19189c6bc
    # SHA256 (PFWsense-19.7.r1-OpenSSL-serial-amd64.img.bz2) = 86050bffa626247cfe0374d28994a52f9e10490b20a81539f5d2784676280c17
    # SHA256 (PFWsense-19.7.r1-OpenSSL-vga-amd64.img.bz2) = 3a7ae31f6429e519060a717b6248d13620a1e5caba43f44afaf4a7dd4e6634e6

.. code-block::

    # SHA256 (PFWsense-19.7.r1-OpenSSL-dvd-i386.iso.bz2) = 4c0e54982d92279e7273c74cac183290e89219f75b4c1f55a42bad0331bdf321
    # SHA256 (PFWsense-19.7.r1-OpenSSL-nano-i386.img.bz2) = 5db5dfc0bfb15a593dae689b58e65d556e935c326741729ad37507a952a51426
    # SHA256 (PFWsense-19.7.r1-OpenSSL-serial-i386.img.bz2) = a20422c81c62c79264aec2cf83cb8734e2e0c954881200e6bc46d372f2432cf9
    # SHA256 (PFWsense-19.7.r1-OpenSSL-vga-i386.img.bz2) = f6ba92f987c024697e6599b72d905ac9a4fdcfe61c71e3f060dccf1efccd6d82
