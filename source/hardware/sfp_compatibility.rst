...
Most PFWsense® appliances feature 10 Gigabit SFP+ cages powered by AMD® `axgbe` to allow
...
Our enterprise & datacenter PFWsense® appliances may also feature 25 Gigabit capable SFP28 cages powered by Intel® `ice`.

Below you can find some general information as well as a list of tested SFP(+)/SFP28 transceiver modules
that are verified to work with PFWsense® appliances.

.. tip::

    If you are using an SFP(+)/SFP28 module on one of the PFWsense® appliances that is not listed below but is working
    properly, consider submitting a Pull Request to `our documentation <https://github.com/pfwsense/docs>`__ to extend the list.
...
.. warning::
    ...
    the datacenter level PFWsense® appliances are equipped with passive cooling for the SFP+ cages. If the ambient
    temperature does not exceed 50°C, RJ45 SFP+ modules can be used in all PFWsense® appliances without issue.
