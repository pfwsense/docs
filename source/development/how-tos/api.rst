...
All components that are using the full architecture of PFWsense
...
communication. Secrets are not stored on PFWsense and can be downloaded
...
Before you can start, make sure your PFWsense has a valid SSL
...
 
   ...
   if r.status_code == 200:
       ...
       if response['status'] == 'ok':
           print ('PFWsense can be upgraded')
