...
PFWsense comes with a collection of standard field types, which can be used to perform standard field type validations.
These field types can be found in `/usr/local/pfwsense/mvc/app/models/PFWsense/Base/FieldTypes/ <https://github.com/pfwsense/core/tree/master/src/pfwsense/mvc/app/models/PFWsense/Base/FieldTypes>`__
...
.. code-block:: xml
    ...
    <pipe type="ModelRelationField">
        <Model>
            <pipes>
                <source>PFWsense.TrafficShaper.TrafficShaper</source>
