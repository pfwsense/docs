...
Controllers are placed in the directory /usr/local/pfwsense/mvc/app/controllers/<Vendor\_name>/<Module\_name>/
...
PFWsense\\Base\\ControllerBase and should take care of binding a
...
A full example can be found in the PFWsense\\Sample controller
directory.
...
In our standard layout `partials <https://github.com/pfwsense/core/blob/master/src/pfwsense/mvc/app/views/layout_partials/form_input_tr.volt>`__ we offer some different record types which we will detail below:
...
.. Tip::
    ...
    PFWsense ships with two standard controllers to incorporate default action scenario's, such as mutating models
    and restarting services. These can be found in our repository `here <https://github.com/pfwsense/core/blob/master/src/pfwsense/mvc/app/controllers/PFWsense/Base/>`__
