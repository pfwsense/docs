...
.. csv-table:: Resources (CommandController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Command.xml <https://github.com/pfwsense/plugins/blob/master/net-mgmt/nrpe/src/pfwsense/mvc/app/models/PFWsense/Nrpe/Command.xml>`__"
...
.. csv-table:: Service (GeneralController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `General.xml <https://github.com/pfwsense/plugins/blob/master/net-mgmt/nrpe/src/pfwsense/mvc/app/models/PFWsense/Nrpe/General.xml>`__"
