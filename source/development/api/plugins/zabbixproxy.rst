...
.. csv-table:: Service (GeneralController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `General.xml <https://github.com/pfwsense/plugins/blob/master/net-mgmt/zabbix-proxy/src/pfwsense/mvc/app/models/PFWsense/Zabbixproxy/General.xml>`__"
