...
.. csv-table:: Service (GeneralController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `General.xml <https://github.com/pfwsense/plugins/blob/master/mail/fetchmail/src/pfwsense/mvc/app/models/PFWsense/Fetchmail/General.xml>`__"
...
.. csv-table:: Resources (MailboxController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Mailbox.xml <https://github.com/pfwsense/plugins/blob/master/mail/fetchmail/src/pfwsense/mvc/app/models/PFWsense/Fetchmail/Mailbox.xml>`__"
