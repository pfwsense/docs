...
.. csv-table:: Resources (ClientsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `RadSecProxy.xml <https://github.com/pfwsense/plugins/blob/master/net/radsecproxy/src/pfwsense/mvc/app/models/PFWsense/RadSecProxy/RadSecProxy.xml>`__"
