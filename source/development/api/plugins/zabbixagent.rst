...
.. csv-table:: Service (ServiceController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `ZabbixAgent.xml <https://github.com/pfwsense/plugins/blob/master/net-mgmt/zabbix-agent/src/pfwsense/mvc/app/models/PFWsense/ZabbixAgent/ZabbixAgent.xml>`__"
