...
.. csv-table:: Service (GeneralController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `General.xml <https://github.com/pfwsense/plugins/blob/master/net-mgmt/net-snmp/src/pfwsense/mvc/app/models/PFWsense/Netsnmp/General.xml>`__"
...
.. csv-table:: Resources (UserController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `User.xml <https://github.com/pfwsense/plugins/blob/master/net-mgmt/net-snmp/src/pfwsense/mvc/app/models/PFWsense/Netsnmp/User.xml>`__"
