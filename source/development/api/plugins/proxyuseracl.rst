...
.. csv-table:: Resources (SettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `ProxyUserACL.xml <https://github.com/pfwsense/plugins/blob/master/www/web-proxy-useracl/src/pfwsense/mvc/app/models/PFWsense/ProxyUserACL/ProxyUserACL.xml>`__"
