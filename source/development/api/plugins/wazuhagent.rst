...
.. csv-table:: Service (ServiceController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `WazuhAgent.xml <https://github.com/pfwsense/plugins/blob/master/security/wazuh-agent/src/pfwsense/mvc/app/models/PFWsense/WazuhAgent/WazuhAgent.xml>`__"
