...
The firewall API plugin is a first step into migrating the legacy firewall components from PFWsense, although it does contain
a user interface, it's main focus is only to provide machine to machine interaction between custom applications and PFWsense
