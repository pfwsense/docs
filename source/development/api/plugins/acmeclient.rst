...
.. csv-table:: Resources (AccountsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `AcmeClient.xml <https://github.com/pfwsense/plugins/blob/master/security/acme-client/src/pfwsense/mvc/app/models/PFWsense/AcmeClient/AcmeClient.xml>`__"
