...
.. csv-table:: Resources (DomainController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Domain.xml <https://github.com/pfwsense/plugins/blob/master/net/siproxd/src/pfwsense/mvc/app/models/PFWsense/Siproxd/Domain.xml>`__"
...
.. csv-table:: Resources (UserController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `User.xml <https://github.com/pfwsense/plugins/blob/master/net/siproxd/src/pfwsense/mvc/app/models/PFWsense/Siproxd/User.xml>`__"
