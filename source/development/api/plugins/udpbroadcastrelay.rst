...
.. csv-table:: Service (ServiceController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `UDPBroadcastRelay.xml <https://github.com/pfwsense/plugins/blob/master/net/udpbroadcastrelay/src/pfwsense/mvc/app/models/PFWsense/UDPBroadcastRelay/UDPBroadcastRelay.xml>`__"
