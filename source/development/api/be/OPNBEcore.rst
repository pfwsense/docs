      ...
      "classes": [
        {
          ...
          "section": "PFWsense.Firewall.Alias",
          "services": [
            "pf"
          ],
...
.. code-block:: python
    ...
    r = requests.get(
        'https://127.0.0.1/api/opncentral/sync/read_config/PFWsense.Firewall.Alias',
...
When executed, this will dump the contents of the configuration path :code:`PFWsense.Firewall.Alias` into a named array
