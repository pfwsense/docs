...
For all PFWsense modules and applications there are some basic style and
...
When creating modules for PFWsense, always name your components like
this: VendorName/ModuleName

In our sample case this will be: PFWsense/HelloWorld
...
models/PFWsense/HelloWorld directory.
...
.. code-block:: php
    :caption: /usr/local/pfwsense/mvc/app/models/PFWsense/HelloWorld/HelloWorld.php

    <?php
    namespace PFWsense\HelloWorld;
     
...
.. code-block:: xml
    :caption: /usr/local/pfwsense/mvc/app/models/PFWsense/HelloWorld/HelloWorld.xml
...
Create a template named index.volt inside the views/PFWsense/HelloWorld
directory containing the following data:


.. code-block:: html
    :caption: /usr/local/pfwsense/mvc/app/views/PFWsense/HelloWorld/index.volt
...
Every PFWsense module should separate presentation from logic, that’s
...
in controllers/PFWsense/HelloWorld/ with the following name
IndexController.php and contents:

.. code-block:: php
    :caption: /usr/local/pfwsense/mvc/app/controllers/PFWsense/HelloWorld/IndexController.php
    ...
    class IndexController extends \PFWsense\Base\IndexController
    {
        public function indexAction()
        {
            ...
            $this->view->pick('PFWsense/HelloWorld/index');
        }
    }
...
.. code-block:: php
    :caption: /usr/local/pfwsense/mvc/app/controllers/PFWsense/HelloWorld/Api/SettingsController.php

    <?php
    namespace PFWsense\HelloWorld\Api;
     
...
models/PFWsense/Base/FieldTypes directory. If specific field types
...
.. code-block:: xml
    :caption: /usr/local/pfwsense/mvc/app/controllers/PFWsense/HelloWorld/forms/general.xml
...
.. code-block:: php
    ...
    use \PFWsense\HelloWorld\HelloWorld;
...
.. code-block:: php
    ...
    class SimplifiedSettingsController extends ApiMutableModelControllerBase
    {
        ...
        protected static $internalModelClass = 'PFWsense\HelloWorld\HelloWorld';
    }
...
and save our form, by using the PFWsense libraries you can validate your
data automatically.
...
::
    ...
    /usr/local/pfwsense/service/templates/PFWsense/HelloWorld/
...
.. code-block:: html+jinja
    :caption: /usr/local/pfwsense/service/templates/PFWsense/HelloWorld/helloworld.conf
...
controllers/PFWsense/HelloWorld/Api/ServiceController.php and add the
...
.. code-block:: php
    ...
    public function reloadAction()
    {
        ...
        if ($this->request->isPost()) {
            $backend = new Backend();
            $bckresult = trim($backend->configdRun("template reload PFWsense/HelloWorld"));
            if ($bckresult == "OK") {
                $status = "ok";
            }
        }
...
::
  ...
  configctl template reload PFWsense/HelloWorld
...
::
    ...
    /usr/local/pfwsense/service/conf/actions.d/actions_helloworld.conf
...
::
    ...
    [test]
    command:/usr/local/pfwsense/scripts/PFWsense/HelloWorld/testConnection.py
    parameters:
    type:script_output
...
PFWsense is available in may different languages like english, german or japanese.
...
.. Note::
    ...
    This makes plugins hard to translate and will decrease the quality of PFWsense in other languages.
...
.. code-block:: xml
    :caption: /usr/local/pfwsense/mvc/app/models/PFWsense/HelloWorld/Menu/Menu.xml
...
.. code-block:: xml
    :caption: /usr/local/pfwsense/mvc/app/models/PFWsense/HelloWorld/ACL/ACL.xml
...
All files are created in their original locations (on the PFWsense
...
::
    ...
    src/pfwsense/mvc/app/controllers/PFWsense/HelloWorld/Api/ServiceController.php
    src/pfwsense/mvc/app/controllers/PFWsense/HelloWorld/Api/SettingsController.php
    src/pfwsense/mvc/app/controllers/PFWsense/HelloWorld/Api/SimplifiedSettingsController.php
    src/pfwsense/mvc/app/controllers/PFWsense/HelloWorld/IndexController.php
    src/pfwsense/mvc/app/controllers/PFWsense/HelloWorld/forms/general.xml
    src/pfwsense/mvc/app/models/PFWsense/HelloWorld/ACL/ACL.xml
    src/pfwsense/mvc/app/models/PFWsense/HelloWorld/HelloWorld.php
    src/pfwsense/mvc/app/models/PFWsense/HelloWorld/HelloWorld.xml
    src/pfwsense/mvc/app/models/PFWsense/HelloWorld/Menu/Menu.xml
    src/pfwsense/mvc/app/views/PFWsense/HelloWorld/index.volt
    src/pfwsense/scripts/PFWsense/HelloWorld/testConnection.py
    src/pfwsense/service/templates/PFWsense/HelloWorld/+TARGETS
    src/pfwsense/service/templates/PFWsense/HelloWorld/helloworld.conf
    src/pfwsense/service/conf/actions.d/actions_helloworld.conf
...
will be a standard pkg package, which you can install on any PFWsense
...
-  source of this example :
   https://github.com/pfwsense/plugins/tree/master/devel/helloworld
-  build instructions : https://github.com/pfwsense/tools
-  practical frontend development : https://github.com/pfwsense/ui_devtools
...
-  PFWsense architecture :doc:`Architecture <../architecture>`
-  PFWsense creating models
