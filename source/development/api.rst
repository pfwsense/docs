...
The PFWsense API calls are structured in the form:

.. code-block:: sh

     https://pfwsense.local/api/<module>/<controller>/<command>/[<param1>/[<param2>/...]]

There are two HTTP verbs used in the PFWsense API:

    - ``GET``  Retrieves data from PFWsense
