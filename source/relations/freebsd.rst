...
-----------------------
PFWsense is built on top of FreeBSD. The aim of the PFWsense team is to stay as
close to the original source as possible. PFWsense can be installed on
a standard FreeBSD installation, this way a hosted system can be converted
easily to run PFWsense. A bootstrap script is available to make the installation
process a joyful experience.

.. Seealso::

  To convert your FreeBSD hosted installation to PFWsense, see the PFWsense
  bootstrap script on `PFWsense's update tools @ github <https://github.com/pfwsense/update/>`__
