...
Local/Server
------------
Installing PFWsense on a virtual machine can be done by using the DVD ISO image.
...
---
**i440FX chipset**
PFWsense on KVM works with virtio disks and network devices (confirmed on QEMU 5.0).

**Q35 chipset**
As of 22.1.x, PFWsense is based on FreeBSD 13.0, which includes support for the virtualized Q35 chipset and newer
...
Others
------
PFWsense can be installed on all virtual machines that support FreeBSD (such as Bhyve, VirtualBox).
...
approach is available in the form of **pfwsense-bootstrap**.

pfwsense-bootstrap
------------------
pfwsense-bootstrap(8) is a tool that can completely reinstall a running system
in place for a thorough factory reset or to restore consistency of all the PFWsense
...
trust by using current package fingerprints -> CA root certificates -> HTTPS -> PFWsense
package fingerprints.

What it will also do is turn a supported stock FreeBSD release into an PFWsense
installation.  Both UFS and ZFS installations are supported.

pfwsense bootstrap is available for our
`github source repository <https://github.com/pfwsense/update/tree/master/bootstrap>`__
...
Installing PFWsense into the Amazon cloud can be a daunting task as no console is
...
PFWsense is also available in the Microsoft Azure Marketplace as an easy installable virtual appliance.
...
PFWsense installation has a minimum of 1 GB of RAM.
