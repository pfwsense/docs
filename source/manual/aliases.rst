...
Alias Types
-----------
PFWsense offers the following alias types:
...
.. Tip::
    ...
    Since external alias types won't be touched by PFWsense, you can use :code:`pfctl` directly in scripts to manage
...
.. Tip::
    ...
    When using LDAP (Active directory), you can synchronise group membership to avoid double administration in PFWsense.
...
the host **pfwsense.firewall** with :code:`curl`. The verbose option provides more details about the data exchanged between the
two machines.
...
::
    ...
    curl \
      ...
      https://pfwsense.firewall/api/firewall/alias_util/add/MyAlias
