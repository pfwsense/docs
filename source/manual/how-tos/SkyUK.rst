...
**Introduction**
-----------------
This doc covers the setup of PFWsense on a Sky UK VDSL connection.
...
PFWsense dhcp6 client sends a release signal to the server it's more than
...
Although PFWsense stores the IPv6 DUID it is possible this can be lost, this
