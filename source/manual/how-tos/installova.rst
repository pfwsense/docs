=============================
Installing PFWsense OVA image
=============================

PFWsense is available as an Open Virtual Appliance (OVA) package, which can be deployed in various
...
Always choose the right type of network before using PFWsense, the imported adapters might not be assigned to a type after import.
