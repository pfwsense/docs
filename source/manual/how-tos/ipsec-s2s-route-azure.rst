...
working PFWsense installation and an Azure virtual network setup with a unique
...
Sample Setup
------------
This sample configuration uses an PFWsense box and the basic Azure virtual network
...
Enable IPsec for PFWsense, select:
...
**You are almost done configuring PFWsense (only some firewall settings remain, which will be addressed later).**
...
-------------------
=================================== ====================== ==================================================
**Name**                             lng.pfwsense           *Freely chosen name*
**IP address**                       1.2.3.4                *The public IP address of your remote PFWsense*
...
-------------------
=================================== ====================== ==================================================
**Name**                             vpn.pfwsense           *Freely chosen name*
**Connection type**                  Site-to-site (IPsec)
**Virtual network gateway**          vpn.gw                 *Select virtual network gateway*
**Local network gateway**            lng.pfwsense           *Select local network gateway*
