...
With this guide we will show you how to configure the server side on PFWsense with the different
...
.. csv-table:: VPN combinations
   :header: "VPN Method", "Win7", "Win10", "Linux", "Mac OS X", "IOS", "Android", "PFWsense config"
