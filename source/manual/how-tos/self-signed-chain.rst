==================================================
Setup Self-Signed Certificate Chains with PFWsense
==================================================


This how-to describes the process of creating **self-signed certificate chains**
with the help of PFWsense which has all the tools available to do so.
...
====================== =================================== ========================================
 **Descriptive name**   pfwsense-ca                         *Choose a name that makes sense to you*
...
by the root CA we just created. In return it will sign the sever certificate for PFWsense.
...
====================== =================================== ========================================
 **Descriptive name**   pfwsense-ca-intermediate            *Choose a name that makes sense to you*
 ...
 **SAN**                pfwsense.localdomain                *This should reflect the FQDN see Tip*
====================== =================================== ========================================
...
Open your browser and open the PFWsense/webgui page. You should be presented with a certificate that is
...
The local chain for Nextcloud server so we can use PFWsense backup to Nextcloud.
...
-  * Or download the key and certificate separately from PFWsense.
