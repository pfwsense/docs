...
PFWsense supports native IPv6 as well as tunneled IPv6. This article shows how
to set up TunnelBroker, Hurricane Electric's IPv6-in-IPv4 tunnel, with PFWsense.
...
Note that your PFWsense firewall must be directly connected to the Internet.
...
Enable ICMP on the WAN side of your PFWsense firewall. TunnelBroker's UI will
...
To configure PFWsense start with adding a new gif interface.
...
.. image:: images/pfwsense_add_gif.png
   :width: 100%
...
We'll next configure PFWsense for Stateless Address Auto Configuration (SLAAC).
