...
This example utilises the new options available in PFWsense 23.1 to setup a site to site tunnel in routed mode
between two PFWsense machines using a pre shared key.
