...
.. image:: images/pfwsense_hotspot_controller.png
    :width: 100%
...
either buy or obtain for free at the reception. PFWsense has built-in support for
...
Prerequisites
-------------
We will start configuration with a fresh PFWsense install, updated to the latest
...
------------------------
The template feature is one of the most powerful features of PFWsense's Captive
...
.. code-block:: html
    ...
    <header class="page-head">
        <div align="center">
          ...
          <h3>See our website for more details: <a href="https://www.pfwsense.org">My Company</a></h3>
        </div>
    </header>
...
Logout. For this feature we will use PFWsense's built-in API calls.
...
-----------------------------
PFWsense has a very powerful CLI that is particularly useful for debugging purposes.
