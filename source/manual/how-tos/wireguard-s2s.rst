...
-----------------------------------------------------
Step 2a - Setup WireGuard Instance on PFWsense Site A
-----------------------------------------------------
...
-----------------------------------------------------
Step 2b - Setup WireGuard Instance on PFWsense Site B
-----------------------------------------------------
...
------------------------------------------------------
Step 3a - Setup WireGuard Peer on PFWsense Site A
------------------------------------------------------
...
------------------------------------------------------
Step 3b - Setup WireGuard Peer on PFWsense Site B
------------------------------------------------------
...
Go to PFWsense Site A :menuselection:`Firewall --> Rules --> LAN A` add a new rule.
...
Go to PFWsense Site A :menuselection:`Firewall --> Rules --> Wireguard (Group)` add a new rule.
...
Go to PFWsense Site B :menuselection:`Firewall --> Rules --> LAN A` add a new rule.
...
Go to PFWsense Site B :menuselection:`Firewall --> Rules --> Wireguard (Group)` add a new rule.
