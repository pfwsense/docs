...
The PFWsense WAF uses NAXSI_, which is a loadable module for the nginx_ web server.
...
* PFWsense blocks User Agents used by Bots automatically - this cannot be configured
...
you should get a message in the server error log as well as an PFWsense
