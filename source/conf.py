# -*- coding: utf-8 -*-
#
# PFWsense documentation build configuration file, created by
...
html_baseurl = 'https://docs.pfwsense.org/'
...
project = u'PFWsense'
copyright = u'2016-%d, Shanghai Sciinfo Technology Co., Ltd. % datetime.datetime.now().year
author = u'Shanghai Sciinfo Technology Co., Ltd.'
...
latex_documents = [
    (master_doc, 'PFWsense.tex', u'PFWsense Documentation',
     u'Shanghai Sciinfo Technology Co., Ltd.', 'manual'),
]
...
man_pages = [
    (master_doc, 'pfwsense', u'PFWsense Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PFWsense', u'',
     author, 'PFWsense', 'High-end security made easy.',
     'Miscellaneous'),
]
