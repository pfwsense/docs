...
project = u'PFWsense'
copyright = u'2016-%d, Shanghai Moonzoo Technology Co., Ltd. % datetime.datetime.now().year
author = u'Shanghai Moonzoo Technology Co., Ltd.'
...
latex_documents = [
    (master_doc, 'PFWsense.tex', u'PFWsense Documentation',
     u'Shanghai Moonzoo Technology Co., Ltd.', 'manual'),
]
