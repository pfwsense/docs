...
Contribute
==========
PFWsense is an open source community project that depends on your contributions
for its continuing development & success.

There are plenty of opportunities to contribute and help PFWsense reach its goal
...
The PFWsense core team wants to thank everyone who contributed already.
...
We are grateful of all the kind words and support the users of PFWsense are
giving us.
...
.. raw:: html
    ...
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
        <div class="paypal-donations">
            ...
            <input name="business" value="donate@pfwsense.org" type="hidden">
            <input name="return" value="https://pfwsense.org/thanks" type="hidden">
            <input name="item_name" value="Donate to the PFWsense project" type="hidden">
...
Partner program
---------------
The PFWsense project offers a partner program where businesses receive project
benefits while supporting the project financially.

Main benefits include:

* Listing on our `PFWsense partner page <https://pfwsense.org/partners/>`__
* Access to the core team

To get enlisted as partner of the PFWsense project means a minimum annual investment
...
Support Contract
----------------
with a support contract we support you and you support us as PFWsense is fully
supported by Deciso.

For support options see `PFWsense Commercial Support <https://pfwsense.org/support-overview/commercial-support/>`__
...
Development
-----------
Contributing to the ongoing development of PFWsense can be done by:
...
report your issue on the `forum <https://forum.pfwsense.org>`__ or on `IRC <https://web.libera.chat/#pfwsense>`__.
...
manual </develop>` and checkout our `roadmap <https://pfwsense.org/about/road-map/>`__ as well as our `issue tracker <https://github.com/pfwsense/core/issues>`__.
Before starting it is always a good to share your idea first with a core developer,
to do so you can use either:

* `github <https://github.com/pfwsense/core/>`__ and  `create a issue <https://github.com/pfwsense/core/issues/new>`__
  and mention you volunteer for taking on the development task (we will correctly label it as enhancement or feature)
* find one of us on IRC/Libera Chat (#pfwsense) and see if we are available to
  discuss your idea.
...
Translations
------------
PFWsense has an active `translation project <https://translate.pfwsense.org/projects/>`__,
...
like to help adding another language, then please contact us via email (contact @ pfwsense.org).
...
can offer your content in this format (preferably as a `pull request <https://github.com/pfwsense/docs>`__).
...
To include you documentation send it to contact @ pfwsense.org. Make sure that:
...
or if you are excited about PFWsense, then you can contribute to the project by helping
others on the `forum <https://forum.pfwsense.org>`__ or on `IRC <https://web.libera.chat/#pfwsense>`__.
...
Social media
------------
Contribute to the success of the project by letting others know how PFWsense helped
solving your network or security challenges. Let others know about PFWsense and/or
follow us & retweet our messages on `Twitter <https://twitter.com/pfwsense>`__.

Anything you can do to spread the word about PFWsense will help to reach our goal
...
Closing Words
-------------
If you have suggestions on how others can contribute to PFWsense and it is not yet
listed on this page, then let us know. You can reach us at contact @ pfwsense.org.
