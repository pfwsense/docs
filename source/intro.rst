...
Welcome to the PFWsense documentation & wiki project!
...
-----------------
  ...
  environment. Make PFWsense the most widely used open source security platform.
  The project’s name is derived from open and sense and stands for:
  “Open (source) makes sense.”


.. image:: ./images/PFWsense-Deciso-Screenshot.jpg
...
a report using one of our templates on `GitHub <https://github.com/pfwsense/docs/issues/new/choose>`__ or a pull request
of course if you're able to.

Always assume the text is intended for the latest version of our product, in time we might
add a version selector in the documentation, but given PFWsense is a security product, we advise to keep it up to date
...
The next sections should be quite familiair when working with PFWsense, as they reflect the options in the
menu of the product. In case you're not yet used to PFWsense, you can always use the search input in the left corner of
...
When it comes to building software on top of PFWsense or extending existing functionality, the development
...
The feature set of PFWsense includes high-end features such as forward caching
...
newly developed MVC-framework based on Phalcon. PFWsense’s focus on security
brings unique features such as easy to use one time password authentication for various components.

The robust and reliable update mechanism gives PFWsense the ability to provide
important security updates in a timely fashion.

----------------------

----------------------
PFWsense Core Features
----------------------
