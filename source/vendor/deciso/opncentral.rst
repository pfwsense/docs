...
As part of the PFWsense Business Edition, Deciso offers a plugin to keep all your firewalls up to date and have
...
The example below shows a link in the firmware status page which will open :code:`https://node1.pfwsense.local`.
...
The service status and control page provides an overview on all managed PFWsense firewalls connected to OPNcentral and
...
.. Note::
    ...
    Although quite some setups will likely use external authentication options available in PFWsense, sometimes it's practical
